...
- **AI content generation** — Generate text content into the document using AI. See `content-ai/capabilities/generation/` in tiptap-docs.
...
- **AI server-side processing** — Run AI workflows on the server. See `content-ai/capabilities/server-ai-toolkit/` in tiptap-docs.
...
Some Tiptap extensions are distributed through a private npm registry. See `guides/pro-extensions` in tiptap-docs for setup instructions.

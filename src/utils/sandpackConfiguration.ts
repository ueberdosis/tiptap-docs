...
export const dependencies = {
  ...
  '@tiptap/extension-details-content': 'next',
  '@tiptap/extension-details-summary': 'next',
  '@tiptap/extension-details': 'next',
  '@tiptap/extension-document': 'next',
  '@tiptap/extension-drag-handle-react': 'next',
  '@tiptap/extension-drag-handle': 'next',
  '@tiptap/extension-dropcursor': 'next',
  '@tiptap/extension-emoji': 'next',
  '@tiptap/extension-file-handler': 'next',
  ...
  '@tiptap/extension-table-of-contents': 'next',
  ...
  '@tiptap/extension-unique-id': 'next',

...
export const proDependencies = {
  ...
  '@tiptap-pro/extension-details-content': 'latest',
  '@tiptap-pro/extension-details-summary': 'latest',
  '@tiptap-pro/extension-details': 'latest',
  '@tiptap-pro/extension-drag-handle-react': 'latest',
  '@tiptap-pro/extension-drag-handle': 'latest',
  '@tiptap-pro/extension-emoji': 'latest',
  '@tiptap-pro/extension-file-handler': 'latest',
  '@tiptap-pro/extension-iframely': 'latest',
  '@tiptap-pro/extension-invisible-characters': 'latest',
  '@tiptap-pro/extension-mathematics': 'latest',
  '@tiptap-pro/extension-node-range': 'latest',
  '@tiptap-pro/extension-table-of-contents': 'latest',
  '@tiptap-pro/extension-unique-id': 'latest',
}

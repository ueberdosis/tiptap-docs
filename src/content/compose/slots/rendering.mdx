...
Use [`subscribeSlotViewUpdates`](/compose/slots/api-reference/utilities#subscribeslotviewupdates) to refresh UI when attributes alone do not change.
...
Content Protection replaces concealed Nodes with its own [redaction renderer](/content-protection/api-reference/rendering). Their original Slot NodeViews do not remain mounted.

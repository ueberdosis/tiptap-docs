...
`JSONContent` comes from `@tiptap/core`. [Configuration](/compose/slots/concepts) and [result types](/compose/slots/api-reference/types) are exported by the Slot package.

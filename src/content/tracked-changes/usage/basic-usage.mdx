...
If you need to create formatting suggestions from application logic, use the programmatic mark commands described in the [commands reference](/tracked-changes/api-reference/commands): `addTrackedMark`, `removeTrackedMark`, and `toggleTrackedMark`.

...
| --- | --- | --- |
| `type` | `SuggestionType` | Filter by [suggestion type](/tracked-changes/api-reference/types#suggestiontype) |
...
const splits = findSuggestions(editor, 'suggestion', { type: 'split' })

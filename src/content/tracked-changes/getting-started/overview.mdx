...
- **Block splits** (`split`) — End-of-block splits use `splitKind: 'insertion'`. Splits in existing content use `splitKind: 'structural'`.
...
- **Block split tracking** — Accept and reject insertion splits and structural splits independently

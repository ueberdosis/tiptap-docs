...
Migrating from Editor.js to Tiptap is straightforward. This guide will help you transition from Editor.js's block-based structure to Tiptap's document model.
...
For Editor.js custom tools, create custom Tiptap extensions. See our [custom extensions guide](/extensions/custom-extensions) for detailed instructions.
...
- [ ] Migrate custom tools to custom extensions or [Node Views](/editor/extensions/custom-extensions/node-views)

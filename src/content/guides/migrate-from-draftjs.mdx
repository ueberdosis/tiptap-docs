...
Migrating from Draft.js to Tiptap is straightforward. This guide will help you transition from Draft.js's immutable state model to Tiptap's extension system.
...
For Draft.js custom entities or decorators, create custom Tiptap extensions. See our [custom extensions guide](/extensions/custom-extensions) for detailed instructions.
...
- [ ] Migrate entities to [Node Views](/editor/extensions/custom-extensions/node-views) or extensions

...
For a comprehensive understanding of how to choose document names, you should review our [authorization guide](/collaboration/getting-started/authenticate#authorize-per-document), as document naming plays a crucial role in access control as well.

...
### Dialog and popup equivalents

CKEditor 4's dialogs can be replaced with custom modals or Tiptap's BubbleMenu for contextual editing:
...
11. Test dialog replacements and user interactions

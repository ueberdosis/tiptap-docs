...
<<<<<<< HEAD
Tiptap Pro extensions add advanced capabilities to the Tiptap Editor such as versioning and AI-assisted content generation. A Tiptap account is required to access Pro extensions. Select extensions such as Snapshots, Comments, and the AI extension also require an active subscription.
=======
...
>>>>>>> 260180371fc1c32dcde48950d99509d59746a1d7

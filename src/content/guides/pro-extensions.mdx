...
1. Sign in to your Tiptap account.
...
<Callout title="Tip" variant="info"> Reference `TIPTAP_PRO_TOKEN` as an environment variable to avoid committing credentials. </Callout>
...
1. Get your Tiptap Pro authentication token from https://cloud.tiptap.dev/v2/features/pro-extensions.
2. Start your trial or subscribe to a Tiptap plan.
3. Add the Tiptap private registry to the package manager configuration.

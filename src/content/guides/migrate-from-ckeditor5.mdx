...
Migrating from CKEditor 5 to Tiptap is straightforward. This guide covers everything you need to know for a smooth transition.
...
For CKEditor 5 custom plugins, create custom Tiptap extensions. See our [custom extensions guide](/extensions/custom-extensions) for detailed instructions.

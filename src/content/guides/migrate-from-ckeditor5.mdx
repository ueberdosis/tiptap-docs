...
Migrating from [CKEditor 5](https://ckeditor.com/) to Tiptap is straightforward. This guide covers everything you need to know for a smooth transition.
...
2. Replace CKEditor 5 initialization with Tiptap setup
3. Map CKEditor 5 plugins to Tiptap extensions
...
9. Test balloon/bubble menu functionality if used
10. Verify image upload and handling
11. Test table functionality if used

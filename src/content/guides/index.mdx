...
meta:
  ...
  description: Explore the Tiptap guides about AI Toolkit, Comments, Collaboration, and more to build dynamic and accessible rich-text editors.
  category: Editor
sidebars:
  hideSecondary: true
---
...
<FilterGrid.Wrapper filters={['Editor', 'Collaboration', 'Migration']}>
  <CardGrid.Wrapper className="sm:grid-cols-3">
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/guides/find-and-replace">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>Build a custom find-and-replace UI</CardGrid.ItemTitle>
          </div>
          <CardGrid.ItemFooter>
            <Tag>Editor</Tag>
          </CardGrid.ItemFooter>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/guides/decorations-vanilla">
          <CardGrid.Subtitle size="sm">Customization · Vanilla JS</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
              Highlight Terms with Decorations in Vanilla JS
            </CardGrid.ItemTitle>
          </div>
          <CardGrid.ItemFooter>
            <Tag>Editor</Tag>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/guides/decorations-react">
          <CardGrid.Subtitle size="sm">Customization · React</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
              Highlight Terms with Decorations in React
            </CardGrid.ItemTitle>
          </div>
          <CardGrid.ItemFooter>
            <Tag>Editor</Tag>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/guides/decorations-vue">
          <CardGrid.Subtitle size="sm">Customization · Vue 3</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
              Highlight Terms with Decorations in Vue 3
            </CardGrid.ItemTitle>
          </div>
          <CardGrid.ItemFooter>
            <Tag>Editor</Tag>

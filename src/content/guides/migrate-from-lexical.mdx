...
Migrating from [Lexical](https://lexical.dev/) to Tiptap is straightforward. This guide will help you transition from Lexical's node-based architecture to Tiptap's extension system.
...
2. Convert Lexical JSON content to HTML
3. Replace Lexical editor initialization with Tiptap setup
4. Map Lexical plugins to Tiptap extensions
5. Migrate custom nodes to [Node Views](/editor/extensions/custom-extensions/node-views)
6. Migrate toolbar plugins to Tiptap UI components
...
10. Update event handlers and command dispatching
11. Test floating toolbar functionality
12. Verify table functionality if used
13. Test history (undo/redo) functionality

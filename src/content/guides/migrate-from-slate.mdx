...
Migrating from [Slate](https://docs.slatejs.org/) to Tiptap is straightforward. This guide will help you transition from Slate's JSON structure to Tiptap's extension system.
...
2. Convert Slate JSON content to HTML or Tiptap JSON
3. Replace Slate editor initialization with Tiptap setup
4. Map Slate plugins to Tiptap extensions
5. Migrate custom elements to [Node Views](/editor/extensions/custom-extensions/node-views)
6. Migrate toolbar components to Tiptap UI
...
11. Test hovering toolbar functionality
12. Verify custom element rendering

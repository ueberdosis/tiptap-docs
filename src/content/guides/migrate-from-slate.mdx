...
Migrating from Slate to Tiptap is straightforward. This guide will help you transition from Slate's JSON structure to Tiptap's extension system.
...
For Slate custom plugins, create custom Tiptap extensions. See our [custom extensions guide](/extensions/custom-extensions) for detailed instructions.
...
- [ ] Migrate custom elements to [Node Views](/editor/extensions/custom-extensions/node-views)

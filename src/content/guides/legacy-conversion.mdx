...
They are no longer supported and will be sunset at any point in 2026 with prior communication from the team. Please migrate to the new [Tiptap Conversion](/conversion/getting-started/overview) extensions and services.
...
<Callout title="Legacy Import Extension Deprecation" variant="warning">
    The **extension-import** package is no longer supported and will be sunset at any point in 2026 with prior communication from the team. Please migrate to the newer [Tiptap Conversion](/conversion/getting-started/overview) extensions.
</Callout>
...
<Callout title="Legacy Export Extension Deprecation" variant="warning">
    The **extension-export** package is no longer supported and will be sunset at any point in 2026 with prior communication from the team. Please migrate to the newer [Tiptap Conversion](/conversion/getting-started/overview) extensions.
</Callout>
...
<Callout title="Legacy /v1/ Conversion REST API Deprecation" variant="warning">
    The **/v1/ Document Conversion REST API** is no longer supported and will be sunset at any point in 2026 with prior communication from the team. Please migrate to the newer [API endpoints](/conversion/getting-started/overview).
</Callout>

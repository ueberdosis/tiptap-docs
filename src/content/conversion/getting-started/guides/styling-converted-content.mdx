...
| Line height | `lineHeight` | String (e.g. `"1.5"`, `"24px"`) | Not rendered (paragraph-level; the mark-level `textStyle.lineHeight` is rendered by `LineHeight`) | `line-height: <value>` |

...
If you want the editor to look like a real document — page boundaries, headers and footers, page format — add the [Pages extension](/pages/getting-started/overview) and PagesTableKit on top of the same setup:

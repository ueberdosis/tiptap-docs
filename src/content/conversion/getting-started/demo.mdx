...
- **Export styles:** The export follows the demo editor's CSS, so the file uses the fonts, sizes and spacing you see in the editor. No custom `styleOverrides` are set. See [Document styles](/conversion/export/docx/document-styles) and [Styling converted content](/conversion/getting-started/guides/styling-converted-content) for how to change that.
...
<Callout variant="hint" title="Full extension list">
  For the complete set of extensions needed to render all importable DOCX content, see the [ConvertKit](/conversion/import/docx/convertkit) page.
</Callout>

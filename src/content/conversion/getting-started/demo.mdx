...
- **Export styles:** The export reads the demo editor's CSS, so the file uses the fonts, sizes and spacing you see in the editor. No custom `styleOverrides` are set. See [Document styles](/conversion/export/docx/document-styles) and [Styling converted content](/conversion/getting-started/guides/styling-converted-content) for how to change that.

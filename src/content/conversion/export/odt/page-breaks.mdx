...
The [PageBreak extension](/pages/core-concepts/page-break-node) lets users insert explicit page breaks in the editor. When combined with the ODT export extension, these page breaks are included in the exported document.
...
- [ODT export guide](/conversion/export/odt/editor-extension) for general export setup

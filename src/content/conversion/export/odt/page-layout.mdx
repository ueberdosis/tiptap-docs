...
Use the `pageColor` option to set a background color for every page of the exported ODT. The value can be a CSS color string or a hex color string without a leading `#`.

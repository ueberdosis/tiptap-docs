...
For a detailed per-feature breakdown including what is not supported (e.g. subscript/superscript, code blocks, cell backgrounds), see the [Supported features](/conversion/getting-started/feature-support-matrix) matrix.

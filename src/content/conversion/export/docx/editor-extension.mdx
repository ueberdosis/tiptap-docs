...
| Element overrides | [`paragraphOverrides`, `textRunOverrides`, `tableOverrides`, `tableCellOverrides`, `imageOverrides`](/conversion/export/docx/styles#element-overrides) | Not supported |

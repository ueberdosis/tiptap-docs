...
| Custom node rendering | Supported via [`customNodes`](/conversion/export/docx/custom-nodes) | Not supported |
| Element overrides | [`paragraphOverrides`, `textRunOverrides`, `tableOverrides`, `tableCellOverrides`, `imageOverrides`](/conversion/export/docx/styles#element-overrides), plus [`headerFooterOverrides`](/conversion/export/docx/styles#headerfooteroverrides) for header/footer-scoped overrides | Not supported |

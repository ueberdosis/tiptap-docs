...
| headerFooterOverrides | Per-field overrides scoped to header/footer content only — fully replace the matching body-wide override inside headers and footers. Only applies to headers/footers auto-extracted from the [Pages extension](/pages/getting-started/overview). [See `headerFooterOverrides`](/conversion/export/docx/styles#headerfooteroverrides)                                                                              | `undefined`                         |

...
| Element overrides     | [`paragraphOverrides`, `textRunOverrides`, `tableOverrides`, `tableCellOverrides`, `imageOverrides`](/conversion/export/docx/styles#element-overrides) | Not yet supported\*            |
...
| paragraphOverrides | Base defaults for all paragraphs. [See Element overrides](/conversion/export/docx/styles#element-overrides)                                                                                                                                                                                                              | `{}`    |
| textRunOverrides   | Base defaults for all text runs. [See Element overrides](/conversion/export/docx/styles#element-overrides)                                                                                                                                                                                                               | `{}`    |
| tableOverrides     | Table-level property overrides. [See Element overrides](/conversion/export/docx/styles#element-overrides)                                                                                                                                                                                                                | `{}`    |
| tableCellOverrides | Base defaults for all table cells. [See Element overrides](/conversion/export/docx/styles#element-overrides)                                                                                                                                                                                                             | `{}`    |
| imageOverrides     | Image property overrides. [See Element overrides](/conversion/export/docx/styles#element-overrides)                                                                                                                                                                                                                      | `{}`    |

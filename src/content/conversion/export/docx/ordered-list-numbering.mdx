...
| `markerFont`   | —                        | Marker-only run formatting (see {@link NumberingMarkerFont} below). Survives DOCX export and is reflected by `generateNumberingFormatCss` in the editor preview.                        |

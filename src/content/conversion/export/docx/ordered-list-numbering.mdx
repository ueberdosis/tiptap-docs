...
- In the browser, list positions follow your editor's CSS by default, see [Document styles](/conversion/export/docx/document-styles#lists). `listLevels` overrides them per list kind and depth, and an item at a depth where you set an indent exports at your indent instead of its position on screen.

...
| ------------------------------------------------------------------------------ | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OrderedListNumbering`                                                         | `@tiptap-pro/extension-convert-kit` | Tiptap extension that adds the `numberingFormat` attribute to `orderedList` and exposes the `setOrderedListNumberingFormat(id)` command, and tracks the active format at the selection via `editor.storage.orderedListNumbering`. Registered by `ConvertKit` (opt in via `orderedListNumbering: true`). Enforces outermost-only on paste. |
...
| DOCX → editor import                                                                                         | Handled by `@tiptap-pro/extension-import-docx`: imported documents return their reconstructed `numberingFormats` and register them with `OrderedListNumbering` automatically. See [Lists](/conversion/content-types/text-and-formatting/lists#import). |

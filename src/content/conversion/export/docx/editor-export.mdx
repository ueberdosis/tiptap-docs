...
You can also use the [REST API](/conversion/export/docx/rest-api) instead if you'd prefer to handle the conversion on our end.

By default, the extension maps Tiptap nodes to DOCX elements. If your content includes custom nodes, configure their [export behavior](/conversion/export/docx/custom-node-conversion) to ensure they’re properly converted.
...
const editor = new Editor({
  extensions: [
    ...
    ExportDocx.configure({
      ...
      headerFooterOverrides: {}, // optional. Default: {}
    }),
    // Other extensions ...
  ],
...
| styleOverrides | An object with custom styles to apply to the exported document. [See Export styles](/conversion/export/docx/export-styles) | `{}` |
| paragraphOverrides | Base defaults for all paragraphs. [See Element overrides](/conversion/export/docx/export-styles#element-overrides) | `{}` |
| textRunOverrides | Base defaults for all text runs. [See Element overrides](/conversion/export/docx/export-styles#element-overrides) | `{}` |
| tableOverrides | Table-level property overrides. [See Element overrides](/conversion/export/docx/export-styles#element-overrides) | `{}` |
| tableCellOverrides | Base defaults for all table cells. [See Element overrides](/conversion/export/docx/export-styles#element-overrides) | `{}` |
| imageOverrides | Image property overrides. [See Element overrides](/conversion/export/docx/export-styles#element-overrides) | `{}` |
| headerFooterOverrides | Per-field overrides applied to Pages-auto-extracted headers/footers only. [See Element overrides](/conversion/export/docx/export-styles#headerfooteroverrides) | `{}` |
...
| **Text run `backgroundColor`** | `textStyle` mark `backgroundColor` exported as solid character shading (previously silently dropped) |
...
| **Tables**                       | ✓ Basic structure, header rows, colspan, rowspan, column widths            |
| **Links**                        | ✓ Hyperlinks                                                               |
| **Media (Images)**               | ✓ Embedded images, size preserved, alt text, editor-resized dimensions     |

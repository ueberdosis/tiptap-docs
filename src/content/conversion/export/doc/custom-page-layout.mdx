...
<Callout title="Consider using DOCX instead" variant="info">
    The DOC format is a legacy format from Microsoft Word 97-2003. For modern use, we recommend exporting to [DOCX](/conversion/export/docx/custom-page-layout) instead. Use DOC only when compatibility with older systems requires it.
</Callout>

...
Use the `pageColor` option to set a background color for every page of the exported DOC. The value is a CSS-like color string; hex values may optionally omit the leading `#`.

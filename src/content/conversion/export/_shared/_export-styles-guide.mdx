...
Links are `0563C1` with a single underline, and `Heading 6` is colored `1F4D78`.
...
In the browser, your editor's CSS also styles individual elements, such as the text in table cells. Your element overrides apply on top of it, and each top-level key you set replaces the whole value for that key. See [Document styles](/conversion/export/docx/document-styles#how-your-options-combine-with-your-css).

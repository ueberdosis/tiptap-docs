...
<Callout title="Convert custom nodes" variant="hint">
    The REST API can only remap these standard nodes and marks to new names. If you want to define how fully custom nodes should appear in a Word (DOCX) file, you must use the Editor extension and [configure custom node]() conversion.
</Callout>

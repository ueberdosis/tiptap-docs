---
title: ODT conversion
meta:
    title: ODT integration | Tiptap Conversion
...
- **REST API** – Integrate ODT conversions on the server side or from external services, without requiring a Tiptap editor.
...
## Import and export via REST API

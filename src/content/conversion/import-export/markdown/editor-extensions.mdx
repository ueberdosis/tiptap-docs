...
<Callout title="Legacy Extension Deprecation" variant="warning">
    The **extension-import** and **extension-export** packages are no longer supported and will be sunset at any point in 2026 with prior communication from the team. Please migrate to the newer [Tiptap Conversion](/conversion/getting-started/overview) extensions.
</Callout>

...
<Callout title="Migrating from the legacy extensions" variant="hint">
  See the [Migration guide](/conversion/legacy/migration-guide) for step-by-step instructions on
  moving to the format-specific Conversion extensions and the `/v2/` REST endpoints.
</Callout>

<Callout title="Default endpoint no longer hosted" variant="warning">
...
<Callout title="Legacy Import Extension (Deprecated)" variant="warning">
  ...
  solutions](/conversion/getting-started/overview) to ensure uninterrupted service.
</Callout>
...
<Callout title="Legacy Export Extension (Deprecated)" variant="warning">
  ...
  transitioning to our updated [export extension](/conversion/getting-started/overview), which
...
<Callout title="Legacy /v1/ Conversion REST API (Deprecated)" variant="warning">
  ...
  and maintenance, migrate to newer [API endpoints](/conversion/getting-started/overview) or check
  out our [Postman

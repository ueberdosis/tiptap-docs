...
tags:
  - type: deprecated
meta:
    title: Legacy Markdown Editor Extensions | Tiptap Conversion
...
<Callout title="Legacy Markdown Editor Extensions (Deprecated)" variant="warning">
    These editor extensions are deprecated and will be sunset at some point in 2026 with prior communication from the team. For new integrations, use the updated [Markdown export extensions](/conversion/export/markdown/editor-extension) and [import REST API](/conversion/import/markdown/rest-api).
</Callout>
...
- **REST API** – Integrate Markdown conversion on the server with the [MD conversion REST API](/conversion/legacy/markdown/rest-api), without using the Tiptap editor directly.

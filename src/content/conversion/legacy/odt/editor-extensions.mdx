...
<Callout title="Legacy ODT Editor Extensions — Deprecated" variant="warning">
    These editor extensions are deprecated and will be sunset at some point in 2026 with prior communication from the team. For new integrations, use the updated [ODT export extensions](/conversion/export/odt/editor-export) and [import extensions](/conversion/import/docx/editor-import).
</Callout>

...
tags:
  - type: deprecated
meta:
    title: Legacy ODT Editor Extensions | Tiptap Conversion
...
<Callout title="Legacy ODT Editor Extensions (Deprecated)" variant="warning">
    These editor extensions are deprecated and will be sunset at some point in 2026 with prior communication from the team. For new integrations, use the updated [ODT export extensions](/conversion/export/odt/editor-extension) and [import extensions](/conversion/import/docx/editor-extension).
</Callout>
...
- **REST API** – Integrate ODT conversions on the server side or from external services with the [ODT Conversion REST API](/conversion/legacy/odt/rest-api).

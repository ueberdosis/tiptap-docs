...
Accepting everything in Tiptap gives the same result as accepting everything in Word. Rejecting matches too, apart from text one reviewer deleted after another had inserted it. See [what is not exported](/conversion/export/docx/tracked-changes#what-is-not-exported).

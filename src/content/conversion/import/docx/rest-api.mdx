...
| Field              | Type    | Description                                                                                                                                                    |
| ------------------ | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `pageLayout`       | `Object` | Page size, orientation and margins read from the document's section properties. Feed it to the [Pages extension](/pages/getting-started/overview) to match Word's page setup. |

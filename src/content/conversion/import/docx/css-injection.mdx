...
meta:
    ...
    description: Extract the default styles from a DOCX file as CSS and inject them into your Tiptap editor on import. Experimental feature; the API may change.
    category: Conversion
---

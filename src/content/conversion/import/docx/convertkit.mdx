...
- 29 bundled extensions wired up to handle everything the Convert API produces.
...
ConvertKit ships **29** extensions inside the single `@tiptap-pro/extension-convert-kit` package. The list below is reference material so you know what shows up in the editor's schema; you do not install or register these separately.

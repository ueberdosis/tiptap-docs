...
| --------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `Paragraph`                 | `spacingBefore`, `spacingAfter`, `lineHeight`, `fontSize`, `indent`, `indentRight`, `firstLineIndent`, `contextualSpacing` | DOCX `w:pPr` + `w:rPr` on paragraph mark                                                                              |
...
| `Table`                     | `width`, `indent`, per-side table border (`width` / `style` / `color` on top/bottom/left/right plus the inside horizontal and vertical grid) (+ `cellMinWidth: 1` default, vs Tiptap's `25`) | DOCX `w:tblW`, `w:tblInd`, `w:tblGrid`, `w:tblBorders`                                                                |

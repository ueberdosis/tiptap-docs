...
- **Extensions:** the `Link` extension for hyperlinks, which `StarterKit` includes. For bookmark targets you also need the `Bookmark` node, which [Convert Kit](/conversion/import/docx/convertkit) registers for you.
...
| Bookmark targets | Supported | Supported (Convert Kit) | Supported |

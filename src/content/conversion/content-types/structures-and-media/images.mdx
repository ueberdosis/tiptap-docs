...
- **Configuration:** An image upload endpoint configured via `imageUploadConfig` on the import extension or REST API request — required regardless of which extension setup you use.

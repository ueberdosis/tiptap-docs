...
When an import is authenticated with [Tiptap access control](/collaboration/getting-started/authenticate) and targets an existing collaborative document, the comments are registered as **live threads on that document automatically** — they are ready to read and reply to the moment the document opens, with no extra wiring on your side.

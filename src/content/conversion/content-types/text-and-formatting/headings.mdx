...
What changes: the exported heading takes its look from your editor's CSS, or from the export's defaults when there's no CSS to read, plus your overrides. The original DOCX's theme styles don't come along, so the original font, size, spacing and color are lost.

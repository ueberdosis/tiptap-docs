...
- `@tiptap/extension-text-style` (base mark)
- `@tiptap/extension-font-family` (adds `fontFamily` attribute)
- `@tiptap/extension-font-size` (adds `fontSize` attribute)
- None are in StarterKit. All must be installed separately.
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeFontFamilySizeImport?hideSource=true" />
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeFontFamilySizeEditor?hideSource=true" />

Both FontFamily and FontSize depend on TextStyle. None are included in StarterKit.
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeFontFamilySizeExport?hideSource=true" />

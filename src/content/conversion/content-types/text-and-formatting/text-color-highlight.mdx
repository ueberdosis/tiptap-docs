...
- `@tiptap/extension-text-style` (base mark that carries color attributes)
- `@tiptap/extension-color` (adds `color` to textStyle)
- `@tiptap/extension-highlight` configured with `multicolor: true`
- None of these are in StarterKit. All must be installed separately.
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeTextColorHighlightImport?hideSource=true" />
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeTextColorHighlightEditor?hideSource=true" />
...
<CodeDemo src="http://localhost:3000/preview/Extensions/ContentTypeTextColorHighlightExport?hideSource=true" />

...
These are inline marks applied to text runs. In Word they come from run properties (`<w:rPr>`). In Tiptap they are marks on text nodes. All four are registered by [ConvertKit](/conversion/import/docx/convertkit) out of the box.

## What you need

- **Extensions:** [`ConvertKit`](/conversion/import/docx/convertkit), which bundles Bold, Italic, Underline, and Strike.
...
All four marks ship inside [`ConvertKit`](/conversion/import/docx/convertkit). No separate installation is needed.

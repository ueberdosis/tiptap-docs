...
<Callout title="Flexibility" variant="info">
  ...
  the exact layout you need. For a detailed guide and more examples, see the [Custom page formats
  section](/pages/core-concepts/page-format#custom-page-formats) of the [Page
  format](/pages/core-concepts/page-format) documentation.
</Callout>

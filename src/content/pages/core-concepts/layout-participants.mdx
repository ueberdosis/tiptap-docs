...
The built-in [PageBreak node](/pages/core-concepts/page-break-node) and the experimental [rows that span a page break](/pages/guides/row-fragmentation) in PagesTableKit both use this API. They get no special access. Your code can do the same things.

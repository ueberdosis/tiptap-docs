...
The built-in [PageBreak node](/pages/core-concepts/page-break-node) and the experimental row fragmentation in [PagesTableKit](/pages/guides/pages-tablekit) both use this API. They get no special access. Your code can do the same things.
...
Row fragmentation in PagesTableKit works this way. Most participants write styles directly and never need it.

...
interface PagesOptions {
  ...
  /** Parse options for header and footer content given as HTML, for example
   *  `{ preserveWhitespace: 'full' }` to keep repeated spaces. */
...
| `headerFooterParseOptions`           | `ParseOptions`                      | `undefined`          | Parse options for header and footer content given as HTML. Set `{ preserveWhitespace: 'full' }` to keep repeated spaces. |

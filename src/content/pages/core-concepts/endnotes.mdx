...
The endnotes overlay label and its Close button are translatable through `overlayLabels`, see [Translating overlay labels](/pages/core-concepts/page-header-footer#translating-overlay-labels).

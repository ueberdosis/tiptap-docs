...
This guide will walk you through setting up a Tiptap editor from scratch, adding the Pages extension for pagination and print-like layout, and enabling DOCX export for a professional, print-ready workflow.
...
<Callout title="Hint">
  The DOCX export extension works seamlessly with Pages. Your page breaks, headers (not yet), and footers (not yet) will be reflected in the exported file.
</Callout>

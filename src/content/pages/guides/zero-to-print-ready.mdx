...
<Callout title="Where to get your App ID and JWT" variant="hint">
  See the [Conversion install guide](/conversion/getting-started/install) for credential setup. JWTs
  must be generated server-side; never embed your secret key in the browser.
</Callout>

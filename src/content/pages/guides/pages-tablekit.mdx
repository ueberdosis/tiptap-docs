...
There is now an experimental opt-in that removes this limit for rows of plain paragraphs. See [Rows that span a page break](/pages/guides/row-fragmentation).

...
Pair PagesTableKit with [ConvertKit](/conversion/import/docx/convertkit) (the DOCX-aware editor kit) and the [ImportDocx extension](/conversion/import/docx/editor-extension). Disable ConvertKit's own table stack so PagesTableKit's `TableKit` can take over:

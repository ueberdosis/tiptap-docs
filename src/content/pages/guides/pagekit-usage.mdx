...
<Callout title="How it works" variant="info">
  PageKit configures both the Pages and Table extensions for you. Pass your Pages options under{' '}
  <code>pages</code> and your Table options under <code>table</code>.
</Callout>

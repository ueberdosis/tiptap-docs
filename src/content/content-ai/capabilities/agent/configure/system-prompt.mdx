...
When using AI Agent with a custom backend, the way to customize the system prompt depends on the AI model provider you are using. Learn more in our [Custom AI Agent integration guide](/content-ai/capabilities/agent/custom-llms).

...
The `onStop` handler is called when the [AI Agent lifecycle](/content-ai/capabilities/agent/features/lifecycle) is finished.
...
| `onStopRunning`         | `Function`                          | `undefined`                    | Called when an AI Agent run is finished                               |

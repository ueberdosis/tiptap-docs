...
The `onStopRunning` handler is called when the AI Agent extension stops running and its [lifecycle](/content-ai/capabilities/agent/features/lifecycle) is finished.

...
meta:
  ...
  description: Learn how to call tools in the server using the Vercel AI SDK.
  category: Content AI
---

This guide explains how to call tools in the server using the Vercel AI SDK. It presents an example of a tool that returns the weather in a given location.

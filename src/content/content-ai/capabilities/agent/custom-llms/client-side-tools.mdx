...
```ts
import { z } from 'zod'
import type { AiAgentToolHandler } from '@tiptap-pro/beta-extension-ai-agent'
import { ToolCallError, invalidArgumentsResponseFormatter } from '@tiptap-pro/beta-extension-ai-agent'
...
```ts
import { AiAgentProvider, toolHandlersStarterKit } from '@tiptap-pro/beta-extension-ai-agent'
...
```ts
import type { AiAgentTool } from '@tiptap-pro/beta-extension-ai-agent-server'
...
```ts
import { AiAgentToolkit, toolsStarterKit } from '@tiptap-pro/beta-extension-ai-agent-server'

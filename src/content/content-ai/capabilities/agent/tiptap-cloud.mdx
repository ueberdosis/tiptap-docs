...
The fastest way to get started with the AI Agent extension is with Tiptap AI Cloud. This works out of the box, you only need to provide the authentication credentials to the extension.

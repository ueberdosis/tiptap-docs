...
<Callout title="Legacy extension" variant="warning">
  To build an AI agent with text-editing capabilities, we recommend migrating to the [AI Toolkit
  extension](/content-ai/capabilities/ai-toolkit/overview). See the [AI agent chatbot
  guide](/content-ai/capabilities/ai-toolkit/guides/ai-agent-chatbot). Legacy extensions continue to
  receive support and bug fixes, but do not have the improved capabilities of the AI Toolkit.
</Callout>
...
The AI Agent extension provides tool definitions for popular AI provider libraries:
...
- [OpenAI](/content-ai/capabilities/ai-toolkit/tools/openai-responses)

...
By using the AI Agent extension with Tiptap AI Cloud, you don't need to worry about the server — we have it built for you. However, if you want to customize the LLM and the tools that the AI Agent has available (so that it can perform other actions besides interacting with the document), you can integrate it with your own backend.

...
## Hide and show changes programmatically

In some situations you might want to compute the changes, but not show them. For example, when you are streaming AI-generated content. You can hide and show changes programmatically using the `setShowAiChanges` command.

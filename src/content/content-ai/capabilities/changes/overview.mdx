...
<Callout title="When to use AI Changes?" variant="warning">
  ...
  Suggestion](/content-ai/capabilities/suggestion/overview) extension. Follow the [preview
  changes](/content-ai/capabilities/suggestion/features/preview-changes) guide.
</Callout>

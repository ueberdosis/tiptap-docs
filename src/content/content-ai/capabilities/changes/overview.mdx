...
<Callout title="Legacy extension" variant="warning">
  For improved performance and a simpler API, migrate to the [AI Toolkit
  extension](/content-ai/capabilities/ai-toolkit/overview). See the ["Compare documents"
  guide](/content-ai/capabilities/ai-toolkit/primitives/compare-documents). Legacy extensions
  continue to receive support but do not have the improved capabilities of the AI Toolkit.
</Callout>

...
- Compatible with our [AI Generation extension](/content-ai/capabilities/generation/text-generation) and our [AI Agent toolkit](/examples/experiments/ai-agent).
- Supports rich text formatting, including images, links, and mentions.
- Lets users [accept or reject individual changes](/content-ai/capabilities/changes/features/review-changes), or make small adjustments to the generated content.

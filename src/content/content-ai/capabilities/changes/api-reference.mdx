...
declare module '@tiptap/core' {
  interface Commands<ReturnType> {
    previewAiAgentChanges: {
       ...
       */
      startAiChanges: (doc?: Node) => ReturnType

      /**
       * Accepts all AI changes in the document, and stops tracking changes.
       */
...
export interface AiChangesStorage {
   ...
   */
  getIsReviewingAiChanges: () => boolean
  /**

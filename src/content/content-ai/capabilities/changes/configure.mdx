...
To show a popover when you select a change, follow [this guide](/content-ai/capabilities/changes/features/display-changes#show-a-popover-when-you-select-a-change).

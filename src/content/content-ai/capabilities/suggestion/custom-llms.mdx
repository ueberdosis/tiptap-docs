...
To learn more about the data that each object should contain, check the [API reference](/content-ai/capabilities/suggestion/api-reference#proofreading-suggestions).

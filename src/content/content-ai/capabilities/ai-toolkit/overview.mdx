...
Or explore the advanced guides:

- [Multi-document AI agent](/content-ai/capabilities/ai-toolkit/advanced-guides/multi-document)
- [Add comments](/content-ai/capabilities/ai-toolkit/advanced-guides/comments)
- [AI engineering guide](/content-ai/capabilities/ai-toolkit/advanced-guides/ai-engineering)
- [Proofreader guide](/content-ai/capabilities/ai-toolkit/advanced-guides/proofreader)

<Callout title="Migrating from another AI extension?" variant="info">
Read the [migration guides](/content-ai/capabilities/ai-toolkit/migration-guides) to replace the other Tiptap AI extensions with the AI Toolkit.
</Callout>

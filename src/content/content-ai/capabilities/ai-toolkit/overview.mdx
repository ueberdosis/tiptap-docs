...
- Tool definitions for AI providers
  - [`@tiptap-pro/ai-toolkit-ai-sdk`](/content-ai/capabilities/ai-toolkit/ai-agent-tools/ai-sdk): [Tool definitions for AI SDK by Vercel](/content-ai/capabilities/ai-toolkit/tools/ai-sdk).

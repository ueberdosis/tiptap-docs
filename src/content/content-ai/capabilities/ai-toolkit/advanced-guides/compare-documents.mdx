...
meta:
  title: Compare documents | Tiptap AIUmbrellaTerm
...
The diff is displayed as [suggestions](/content-ai/capabilities/ai-toolkit/api-reference/suggestions) in the editor. Add this CSS file to your app to format suggestions as a red and green diff:
...
- [`acceptSuggestion`](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#acceptsuggestion): Accept a specific change
- [`rejectSuggestion`](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#rejectsuggestion): Reject a specific change
- [`acceptAllSuggestions`](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#acceptallsuggestions): Accept all changes
- [`rejectAllSuggestions`](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#rejectallsuggestions): Reject all changes

Call `getSuggestions` to get a list of changes between the documents, stored as [suggestions](/content-ai/capabilities/ai-toolkit/api-reference/suggestions).

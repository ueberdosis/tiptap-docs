...
To implement the same functionality with the AI Toolkit, the recommend path is to follow the [Insert Content workflow](/content-ai/capabilities/ai-toolkit/workflows/insert-content).

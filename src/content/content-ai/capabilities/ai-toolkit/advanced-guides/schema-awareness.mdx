...
Alternatively, you can configure the `customNodes` option of the `getHtmlSchemaAwareness` method. Learn more about the configuration options in the [API Reference](/content-ai/capabilities/ai-toolkit/primitives/schema-awareness#gethtmlschemaawareness).
...
- [Schema awareness API reference](/content-ai/capabilities/ai-toolkit/primitives/schema-awareness)

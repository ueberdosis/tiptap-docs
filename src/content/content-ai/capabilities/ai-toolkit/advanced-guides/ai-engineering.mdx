...
- Claude Haiku 4.5 (Anthropic): We've found this model to be as accurate at applying precise edits as Claude Sonnet 4.5, while being faster and more budget-friendly. We recommend it for most agentic document editing tasks.
- GPT-5 (OpenAI).
- Grok 4 Fast (xAI).
- GLM-4.6 (Z.ai)

...
However, in the system prompt, you can reference the [available tools](/content-ai/capabilities/ai-toolkit/agents/tools/available-tools) by their name. This way, you can instruct the AI model on how and when to use the tools, and guide the AI model to make it more verbose, creative, or thoughtful.

...
To proofread a sub-section of the document, set the `range` option. This argument takes a [Range](/content-ai/capabilities/ai-toolkit/advanced-guides/concepts#range) that describes the region where the document will be proofread.
...
- [Display suggestions](/content-ai/capabilities/ai-toolkit/api-reference/display-suggestions): Learn about reviewing the document and displaying suggestions in the editor.

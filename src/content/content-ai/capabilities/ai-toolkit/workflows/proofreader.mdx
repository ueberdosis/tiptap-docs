...
To proofread a sub-section of the document, set the `range` option. This argument takes a [Range](/content-ai/capabilities/ai-toolkit/advanced-guides/concepts#range) with the region where the document will be proofread.
...
Configure the [review options](/content-ai/capabilities/ai-toolkit/api-reference/review-options) to show proofreading suggestions that users can accept or reject.
...
See the [Suggestions](/content-ai/capabilities/ai-toolkit/agents/review-changes) guide to learn more about suggestions.

## Related guides

- [API reference](/content-ai/capabilities/ai-toolkit/api-reference/read-the-document#tiptapread) of the `tiptapRead` method
- [API reference](/content-ai/capabilities/ai-toolkit/api-reference/read-the-document#tiptapreadchunks) of the `tiptapReadChunks` method
- [API reference](/content-ai/capabilities/ai-toolkit/api-reference/workflows#proofreaderworkflow) of the `proofreaderWorkflow` method
- [Suggestions](/content-ai/capabilities/ai-toolkit/agents/review-changes): Learn about reviewing the document and displaying suggestions in the editor.

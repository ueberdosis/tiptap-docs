...
Configure the [review options](/content-ai/capabilities/ai-toolkit/api-reference/review-options.mdx) to show proofreading suggestions that users can accept or reject

...
To let users review inserted content, configure the [review options](/content-ai/capabilities/ai-toolkit/api-reference/review-options). Changes will show up as suggestions that users can accept or reject.

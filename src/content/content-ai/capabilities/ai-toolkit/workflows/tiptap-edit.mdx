...
To let users review changes, configure the [review options](/content-ai/capabilities/ai-toolkit/api-reference/review-options). Changes will show up as suggestions that users can accept or reject.

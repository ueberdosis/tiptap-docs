...
- `displayOptions?` (`DisplayOptions`): Controls how differences are rendered as suggestions. [See available options](/content-ai/capabilities/ai-toolkit/api-reference/review-options).

...
After editing the document, a list of [suggestions](/content-ai/capabilities/ai-toolkit/agents/review-changes) will be displayed.
...
- `displayOptions?` (`DisplayOptions`): Customize how suggestions are displayed in the editor UI. Sets the `displayOptions` property of the [`Suggestion`](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#the-suggestion-object) type. [See available options](/content-ai/capabilities/ai-toolkit/api-reference/suggestions#the-suggestion-object).

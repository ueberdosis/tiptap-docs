...
## Guide: compare documents in real time
...
If `otherDoc` is omitted, the current document is used by default. Then, when the document changes, a diff of the document before and after the changes is displayed.

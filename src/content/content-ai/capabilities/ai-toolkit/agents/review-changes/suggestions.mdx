...
When reviewing changes, the AI Toolkit displays the preview of the changes as [suggestions](/content-ai/capabilities/ai-toolkit/api-reference/suggestions).

You can customize how these suggestions are displayed, by setting the `reviewOptions.displayOptions` parameter. You can even [render React components](/content-ai/capabilities/ai-toolkit/agents/review-changes/style-suggestions) inside them.

...
meta:
  title: Selection awareness | Tiptap AIUmbrellaTerm
...
- Learn more about the `getActiveSelection` and `setActiveSelection` methods in the [API reference](/content-ai/capabilities/ai-toolkit/api-reference/execute-tool#setactiveselection).

...
Popular AI agent chatbots like [Cursor](https://www.cursor.com/) call multiple tools in a row. You can combine this guide with [Tool streaming](/content-ai/capabilities/ai-toolkit/agents/tool-streaming) to stream operations and keep the assistant responsive while suggestions are reviewed.

### Customize how suggestions are displayed

When reviewing changes, the AI Toolkit displays the preview of the changes as [suggestions](/content-ai/capabilities/ai-toolkit/api-reference/display-suggestions).

...
To implement this feature, we'll use the AI Toolkit's capability to [compare documents in real-time](/content-ai/capabilities/ai-toolkit/advanced-guides/compare-documents).
...
When the AI modifies the document, the changes are displayed as [suggestions](/content-ai/capabilities/ai-toolkit/api-reference/display-suggestions) inside the editor.
...
Learn more about the AI Toolkit's capability to [compare documents in real-time](/content-ai/capabilities/ai-toolkit/advanced-guides/compare-documents).

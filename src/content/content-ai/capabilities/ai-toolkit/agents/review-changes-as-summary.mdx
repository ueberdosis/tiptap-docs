...
To implement this feature, we'll use the AI Toolkit's capability to [compare documents in real time](/content-ai/capabilities/ai-toolkit/api-reference/compare-documents).
...
Learn more about the AI Toolkit's capability to [compare documents in real time](/content-ai/capabilities/ai-toolkit/api-reference/compare-documents).

...
The AI can also be instructed to perform specific actions. Thanks to the [tool definitions](/content-ai/capabilities/ai-toolkit/agents/tools/available-tools), the AI understands the concepts of threads, comments, resolved threads, and replies.

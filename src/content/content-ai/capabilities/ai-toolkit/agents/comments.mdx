...
Want to make document edits and associate them with comments? See the [tracked changes with comments guide](/content-ai/capabilities/ai-toolkit/agents/review-changes/tracked-changes-with-comments) to learn how to combine AI-generated tracked changes with comment threads that explain each change.

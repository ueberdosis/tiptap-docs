...
An array containing the enabled tool definitions in a generic format. Each tool definition is an object with `name`, `description`, and `inputSchema` properties. To see the full list of tools, see the [Available tools](/content-ai/capabilities/ai-toolkit/agents/tools/available-tools) page.

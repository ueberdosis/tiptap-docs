...
Display a review UI while streaming content. This way, users can accept or reject AI-generated changes.
...
Follow the [review changes guide](/content-ai/capabilities/ai-toolkit/agents/review-changes) to learn how to set up the review UI and configure it.

## Next steps

- [Review changes guide](/content-ai/capabilities/ai-toolkit/agents/review-changes): Let users preview and approve changes before they're applied.

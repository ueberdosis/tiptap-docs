...
This guide is a variation of the [Review changes guide](/content-ai/capabilities/ai-toolkit/guides/review-changes). In that guide, the AI agent chatbot previews the changes before they are applied, every time it wants to make a change to the document. In this guide, the AI agent chatbot can do as many changes as it wants, and then the user can review all of them at once.
...
```tsx
const result = toolkit.startComparingDocuments({
  displayOptions: {

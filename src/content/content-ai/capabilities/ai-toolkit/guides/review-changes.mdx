...
You can see a complete reference of the `reviewOptions` parameter in the [API reference](/content-ai/capabilities/ai-toolkit/primitives/execute-ai-agent-tools) for the `executeTool` method.

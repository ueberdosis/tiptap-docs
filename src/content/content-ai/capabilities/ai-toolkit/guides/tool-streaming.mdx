...
Instead of calling the `executeTool` method, call `streamTool` to see changes in real-time as the AI generates them. This creates a more engaging user experience where users can watch the AI make changes incrementally.

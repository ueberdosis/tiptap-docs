...
Instead of calling the `executeTool` method, call `streamTool` to see the document being edited in real-time as the AI generates content. This creates a more engaging user experience.

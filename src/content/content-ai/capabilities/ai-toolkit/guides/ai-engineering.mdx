...
The speed and latency does not only depend on the model, but also on the provider. If output speed is your priority, there are providers specialized in fast inference like [groq](https://groq.com/), [SambaNova](https://www.sambanova.com/) or [Cerebras](https://www.cerebras.ai/).

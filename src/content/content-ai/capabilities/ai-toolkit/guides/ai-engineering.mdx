...
However, we've noticed smaller models can sometimes fail to apply small edits to the document precisely and efficiently. To avoid tool call failures, disable to `applyPatch` tool.

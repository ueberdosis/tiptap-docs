...
To see all other AIBasicTerm extension configuration option, head over to the [install](/content-ai/capabilities/generation/install#configure-the-extension) page.

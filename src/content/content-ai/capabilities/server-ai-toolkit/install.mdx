...
For more details, see the [Editor context API reference](/content-ai/capabilities/server-ai-toolkit/api-reference/schema-awareness).
...
const response = await fetch(`${apiBaseUrl}/v3/ai/toolkit/get-tools`, {
  method: 'POST',

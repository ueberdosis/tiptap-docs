...
Install the Tiptap AI Toolkit and the server tool definitions for the Vercel AI SDK:
...
The endpoint creates a Server AI Toolkit instance with Tiptap Cloud storage, passes the tool definitions to the AI model, and streams the response back to the client.
...
Get your Tiptap Cloud credentials from the [Tiptap Cloud dashboard](https://cloud.tiptap.dev/). Create an Anthropic API key in the [Anthropic Console](https://console.anthropic.com/).

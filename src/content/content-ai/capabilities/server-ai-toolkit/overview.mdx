...
[Tiptap Shorthand](/content-ai/capabilities/server-ai-toolkit/advanced-guides/tiptap-shorthand) is a token-efficient format for encoding Tiptap documents, that helps you reduce AI token costs by up to 80% without sacrificing accuracy.

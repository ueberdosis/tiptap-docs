...
AI agents can interact with Tiptap documents on the server to accomplish complex tasks. The Server AI Toolkit contains [built-in tools](/content-ai/capabilities/server-ai-toolkit/api-reference/tools) that allow your AI to read and edit documents server-side.
...
The Server AI Toolkit provides [tool definitions](/content-ai/capabilities/server-ai-toolkit/api-reference/tools) that your AI agent can call to interact with documents on the server. These tools enable reading content and making edits efficiently.

...
AI agents can interact with Tiptap documents on the server to accomplish complex tasks. The Server AI Toolkit contains [built-in tools](/content-ai/capabilities/server-ai-toolkit/api-reference/rest-api#available-tools) that allow your AI to read and edit documents server-side.
...
The Server AI Toolkit provides [tool definitions](/content-ai/capabilities/server-ai-toolkit/api-reference/rest-api) that your AI agent can call to interact with documents on the server. These tools enable reading content and making edits efficiently.
...
In AI agents, the AI model can choose from a set of tools to perform a task. In [Workflows](/content-ai/capabilities/server-ai-toolkit/workflows), on the other hand, the developer chooses what tool to call, and provides a clear set of steps that the AI must follow.
...
[Workflows](/content-ai/capabilities/server-ai-toolkit/workflows) for single-purpose server-side
automations will be available in upcoming releases of the Server AI Toolkit.

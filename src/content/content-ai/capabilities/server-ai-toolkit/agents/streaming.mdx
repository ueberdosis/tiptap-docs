...
2. As the model generates the tool call, your server forwards the raw input deltas to `POST /v3/ai/toolkit/stream-tool` as [NDJSON](https://github.com/ndjson/ndjson-spec) `start`, `delta`, and `end` messages.

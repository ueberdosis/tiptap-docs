...
When the user sends a message, include the editor context data, document ID, and captured
...
- Learn about [editor context](/content-ai/capabilities/server-ai-toolkit/api-reference/schema-awareness)

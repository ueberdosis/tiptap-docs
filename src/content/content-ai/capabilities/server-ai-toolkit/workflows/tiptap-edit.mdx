...
To run the Tiptap Edit workflow with tracked changes, keep the same setup and change the execute
request to use tracked changes instead of direct edits:
...
Then render tracked-changes controls in the editor so users can review and accept or reject the AI
changes:

...
The guide structure will stay the same:

- first generate the replacement content
- then execute the workflow
- then enable tracked changes in the execute request once the workflow supports it

      ...
      children: [
        {
          ...
          children: [
            ...
            {
              title: 'Agents',
              href: '/content-ai/capabilities/ai-toolkit/build-ai-agents',
              children: [
                {

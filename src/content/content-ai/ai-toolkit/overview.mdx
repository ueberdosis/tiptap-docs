...
- [Build an AI Agent](/content-ai/ai-toolkit/guides/ai-agent-chatbot)
...
- `@tiptap-pro/ai-toolkit`: Includes the `AIToolkit` extension and primitives
  - [Execute AI Agent tools](/content-ai/ai-toolkit/primitives/execute-ai-agent-tools)
  - [Read the document](/content-ai/ai-toolkit/primitives/read-the-document)
  - [Edit the document](/content-ai/ai-toolkit/primitives/edit-the-document)
  - [Get document metadata](/content-ai/ai-toolkit/primitives/get-document-metadata)
  - [Compare documents](/content-ai/ai-toolkit/primitives/compare-documents)
  - [Display suggestions](/content-ai/ai-toolkit/primitives/display-suggestions)
  - [Diff utility](/content-ai/ai-toolkit/primitives/diff-utility)
- Tool definitions for each AI provider
  - [`@tiptap-pro/ai-toolkit-ai-sdk`](/content-ai/ai-toolkit/ai-agent-tools/ai-sdk): Tool definitions for Vercel AI SDK (and a blueprint for other providers)

...
Create a CSS file to style suggestions in red/green.
...
You can see a complete reference of the `reviewOptions` parameter in the API reference for the [`executeTool` method](/content-ai/ai-toolkit/primitives/execute-ai-agent-tools).

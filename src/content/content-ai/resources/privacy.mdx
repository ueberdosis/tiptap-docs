---
title: AIUmbrellaTerm privacy
meta:
  title: Privacy | Tiptap AIUmbrellaTerm
  description: Learn how Tiptap AIUmbrellaTerm protects your data with encrypted storage, secure proxying, and optional on-premise deployment for full control.
  category: AIUmbrellaTerm
---

At Tiptap we value your privacy. So when using Tiptap AIUmbrellaTerm that topic may raise some questions which we like to address in detail below.

## Cloud integration

The Tiptap AIUmbrellaTerm Cloud Version **acts as a proxy** between your client (the Tiptap Editor) and OpenAI. This is done to protect your OpenAI secret from the client, as it is an anti-pattern to share secrets publicly and user-facing.

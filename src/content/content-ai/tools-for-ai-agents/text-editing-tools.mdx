...
meta:
  ...
  description: Add text-editing tools to your AI Agent.
  category: Content AI
---
...
To get started integrating text-editing tools into your AI Agent, read the [AI Agent extension guide](/content-ai/capabilities/agent).

...
Information about security incidents and patches can be found in our [Patched Incidents](/resources/patched-incidents) page. This page provides details about resolved security vulnerabilities and the measures we've taken to address them.

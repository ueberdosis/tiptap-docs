...
<Section
  title="Extensions"
  description="Our AI extensions work out-of-the-box with Tiptap Cloud, so you can deploy them without a backend. They are also easily extendable to work with your custom backend and LLMs."
>

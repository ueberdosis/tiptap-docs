...
<div className="grid sm:grid-cols-2 gap-5">
  ...
  <ProductCard
    ...
    documentationUrl="/content-ai/extensions/ai-suggestion/getting-started/overview"
    icon={contentAIIcon.src}
  />
</div>
...
- [AI Suggestion](/content-ai/extensions/ai-suggestion/getting-started/overview)

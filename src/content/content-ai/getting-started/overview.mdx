...
<Requirements>
    ...
    <RequirementItem label="2. Integrate an AI provider">
        Configure OpenAI in your [AI settings](https://cloud.tiptap.dev/v2/cloud/ai) or review the [Custom LLM guides](http://localhost:3000/content-ai/custom-llms).
    </RequirementItem>
...
<Callout title="Content AI components coming soon" variant="hint">
    UI components and templates for Content AI are on the way. If you’re already using Tiptap’s UI Components, you’ll be able to drop them in with minimal changes as soon as they ship.
</Callout>

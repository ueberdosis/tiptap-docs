...
To learn how to show a tooltip when you select a suggestion, follow [this guide](/content-ai/extensions/ai-suggestion/features/display-suggestions#show-a-tooltip-when-you-select-a-suggestion).
...
If you do not [provide your own backend](/content-ai/extensions/ai-suggestion/integrate-your-own-llms), the AI Suggestion extension will use the Tiptap Content AI cloud to generate suggestions.
...
You will find a more comprehensive guide on how to integrate your own backend and LLMs [in this guide](/content-ai/extensions/ai-suggestion/integrate-your-own-llms).

...
If you do not [provide your own backend](/content-ai/extensions/ai-suggestion/custom-llms/integrate), the AI Suggestion extension will use the Tiptap Content AI cloud to generate suggestions.
...
You will find a more comprehensive guide on how to integrate your own backend and LLMs [in this guide](/content-ai/extensions/ai-suggestion/custom-llms/integrate).

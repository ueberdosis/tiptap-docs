...
meta:
  title: Integrate your Custom Backend and LLMs | Tiptap AI Suggestion
...
The AI Suggestion supports different degrees of customization. You can:
...
To learn more about the data that each object should contain, check the [API reference](/content-ai/extensions/ai-suggestion/api-reference#proofreading-suggestions).

---
title: Use the AI Suggestion with Tiptap Content AI Cloud
meta:
  title: Use Tiptap Content AI Cloud | Tiptap AI Suggestion
  description: Get started with the AI Suggestion by generating suggestions with the Tiptap Content AI Cloud API.
  category: Content AI
---

The easiest way to get started with the AI Suggestion is to let the suggestions be generated with the Tiptap Content AI Cloud API. This works out of the box, you only need to provide the authentication credentials to the extension.

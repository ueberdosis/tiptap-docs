...
We recommend using the [Floating UI](https://floating-ui.com/) library to display the tooltip. You can see an example on how to do it [in the Demo](/content-ai/extensions/ai-suggestion/getting-started/overview).

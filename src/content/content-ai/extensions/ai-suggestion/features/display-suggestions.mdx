...
meta:
  ...
  description: Customize how AI Suggestions are displayed in the editor with custom styles and tooltips.
  category: Content AI
---
...
For more advanced styles, use the `getCustomSuggestionDecoration` [configuration option](/content-ai/extensions/ai-suggestion/configure#custom-suggestion-styles).
...
To learn how to show a tooltip to the suggestions, [follow this guide ](/content-ai/extensions/ai-suggestion/features/display-suggestions#show-a-tooltip-when-you-select-a-suggestion).
...
An essential feature of modern AI Suggestions is the ability to show a tooltip when you select a suggestion. This tooltip usually provides extra information about the suggestion, and allows the user to accept or reject it.
...
We recommend using the [Floating UI](https://floating-ui.com/) library to display the tooltip. You can see an example on how to do it [in the demo](/content-ai/extensions/ai-suggestion/overview).
...
You can access the current suggestions from the extension's [storage object](/content-ai/extensions/ai-suggestion/api-reference#extension-storage).

...
The easiest way to get started with the AI Suggestion is to use Tiptap Content AI Cloud. Our API will generate suggestions from your rules and content. Follow this setup guide: [Use Tiptap Content AI Cloud](/content-ai/extensions/ai-suggestion/use-with-content-ai-cloud)

You can also use your own backend and LLMs to generate proofreading suggestions. You can find a guide here: [Integrate your own backend and LLMs](/content-ai/extensions/ai-suggestion/integrate-your-own-llms)

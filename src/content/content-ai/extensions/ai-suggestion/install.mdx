...
You can customize the suggestions' appearance even more by providing custom decorations. To show a tooltip when you select a suggestion, [follow this guide](/content-ai/extensions/ai-suggestion/features/display-suggestions#show-a-tooltip-when-you-select-a-suggestion).

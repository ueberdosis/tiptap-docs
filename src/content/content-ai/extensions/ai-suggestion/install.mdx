...
You can also use your own backend and LLMs to generate proofreading suggestions. You can find a guide here: [Integrate your own backend and LLMs](/content-ai/extensions/ai-suggestion/custom-llms).

---
title: Integrate the AI Proofreader Extension with Your Own Backend and LLMs
meta:
  title: Integrate Your Own Backend and LLMs | Tiptap AI Proofreader
...
If you want to improve the suggestions' quality, you can use a more powerful model like `gpt-4o`. Bear in mind that more powerful models are more expensive, slower, and have a higher latency.
...
- If you use the `replacements` format, you can use OpenAI’s structured outputs (or the equivalent in other LLM providers) to ensure that the response is a JSON object that complies to a specific schema
- If you use the `fullHml` format, you can use OpenAI’s predicted outputs (or the equivalent option in other LLM providers) to improve the latency and speed of the model.

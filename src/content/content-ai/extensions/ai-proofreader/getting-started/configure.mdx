...
You can learn more about rules in this guide: [Define rules](/content/content-ai/extensions/ai-proofreader/features/define-your-own-rules.mdx)
...
If you do not [provide your own backend](/content-ai/extensions/ai-proofreader/integrate-your-own-backend-and-llms), the AI Proofreader extension will use the Tiptap Content AI cloud to generate suggestions.
...
You will find a more comprehensive guide on how to integrate your own backend and LLMs [in this guide](/content-ai/extensions/ai-proofreader/integrate-your-own-backend-and-llms).

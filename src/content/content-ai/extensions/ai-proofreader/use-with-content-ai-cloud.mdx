---
title: Use the AI Proofreader Extension with Tiptap Content AI Cloud
meta:
  title: Use Tiptap Content AI Cloud | Tiptap AI Proofreader
  description: Get started with the AI Proofreader by generating suggestions with the Tiptap Content AI Cloud API.
  category: Content AI
---

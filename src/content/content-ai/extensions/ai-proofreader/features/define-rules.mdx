---
title: Define Rules for the AI Proofreader
meta:
  title: Define Rules | Tiptap AI Proofreader
  description: Configure the AI Proofreader extension with a list of rules to generate suggestions.
  category: Content AI
---
...
Each rule has an id. It must be unique, so that the LLM can associate the suggestions with the correct rule.

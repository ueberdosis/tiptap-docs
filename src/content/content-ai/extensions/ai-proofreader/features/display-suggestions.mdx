...
To learn how to show a tooltip to the suggestions, follow this guide ( [link to the guide](https://www.notion.so/Tiptap-AI-Proofreader-documentation-proposal-1b601ffa3ebc80cab745e71a65643172?pvs=21)).
...
![image.png](Tiptap%20AI%20Proofreader%20documentation%20proposal%201b601ffa3ebc80cab745e71a65643172/image%201.png)
...
// Then, add the content to the custom element. In this example, we use React Portals to render the tooltip outside the editor.
if (tooltipElement) {
  ReactDOM.createPortal(<Tooltip suggestion={editor.selectedSuggestion} />, tooltipElement)
}
```

You can see an example on how to do it in the Demo: [Overview](https://www.notion.so/Overview-1b901ffa3ebc80f7ad3ecfa885bda27d?pvs=21)

...
meta:
  ...
  description: Set up your Content AI extension to autocomplete and stream text when a user hits tab in your editor. More in the docs!
  category: Content AI
---
...
To see all other Content AI extension configuration option, head over to the [install](/content-ai/extensions/ai/getting-started/install#configure-the-extension) page.

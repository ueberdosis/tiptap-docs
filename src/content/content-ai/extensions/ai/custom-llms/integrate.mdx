...
meta:
  ...
  description: Implement custom LLMs with the advanced AI extension and override resolver functions in your editor. Learn more in the docs!
  category: Content AI
---
...
If you want to rely on our cloud in some cases, make sure that you [setup your team as described here](/content-ai/extensions/ai/getting-started/install#set-up-tiptap-ai-for-your-team).

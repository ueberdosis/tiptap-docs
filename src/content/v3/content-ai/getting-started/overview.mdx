...
Integrate [OpenAI](/content-ai/getting-started/install) or your own [Custom LLM](/content-ai/custom-llms/integrate) with your Tiptap Editor. The extension covers both, the client and server-side implementations. Here’s the user experience:

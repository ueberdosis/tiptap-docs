...
**Tiptap doesn’t support Markdown as an input or output format**. We decided against supporting Markdown because:
...
That said, Tiptap does support [Markdown shortcuts](/examples/basics/markdown-shortcuts) to format your content. Also you’re free to let your content look like Markdown, for example add a `#` before an `<h1>` with CSS.

...
This action is only required if your project includes the Tiptap [StarterKit](/3.x/editor/extensions/functionality/starterkit) or [Undo/Redo](/3.x/editor/extensions/functionality/undo-redo) extension.

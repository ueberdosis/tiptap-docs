...
| Key                                | Description                                                                                                                                                           |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `secret`                           | [JWT token secret](/3.x/collaboration/getting-started/authenticate), auto-generated on the first launch                                                               |
...
| `webhook_loader_url`               | Optional webhook URL for initially loading documents. See [webhooks](/3.x/collaboration/core-concepts/webhooks#loader-webhook) for more information.                  |
...
Review the [metrics](/3.x/collaboration/operations/metrics) page for additional information.

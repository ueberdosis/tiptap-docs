...
The following demo uses the Document Conversion API by integrating both the [import](/3.x/editor/extensions/functionality/import) and [export](/3.x/editor/extensions/functionality/export) extensions into the editor.
...
- [Editor Import Extension](/3.x/editor/extensions/functionality/import)
- [Editor Export Extension](/3.x/editor/extensions/functionality/export)

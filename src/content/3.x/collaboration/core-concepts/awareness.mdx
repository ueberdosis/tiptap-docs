...
Awareness updates trigger specific [provider events](/3.x/collaboration/provider/events) to develop interactive features based on user actions and presence:
...
With your [collaborative environment](/3.x/collaboration/getting-started/install) set up, you're all set to integrate Awareness, which is natively supported by the Collaboration Provider.
...
With basic Awareness in place, consider adding the [Collaboration Caret](/3.x/editor/extensions/functionality/collaboration-caret) extension to your editor. This extension adds caret positions, text selections, and personalized details (such as names and colors) of all participating users to your editor.

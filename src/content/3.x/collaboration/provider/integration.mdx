...
The Tiptap Collaboration provider offers several settings for custom configurations. Review the tables below for all parameters, practical use cases, and key concepts like "[awareness](/3.x/collaboration/core-concepts/awareness)".

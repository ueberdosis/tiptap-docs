...
- [Pre-configured default commands](/3.x/content-ai/capabilities/text-generation)
- [Autocompletion for efficient editing](/3.x/content-ai/capabilities/text-generation/autocompletion)
- Real-time streaming for commands
- Compatibility with various OpenAI models (e.g., gpt-3.5-turbo, gpt-4, gpt-4o, dall-e-3)
- [Create your own prompts and commands](/3.x/content-ai/capabilities/text-generation/custom-commands)
- [Custom LLM integration for business accounts](/3.x/content-ai/custom-llms/integrate)

## How it works

Integrate [OpenAI](/3.x/content-ai/getting-started/install) or your own [Custom LLM](/3.x/content-ai/custom-llms/integrate) with your Tiptap Editor. The extension covers both, the client and server-side implementations. Here’s the user experience:

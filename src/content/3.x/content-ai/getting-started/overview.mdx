...
<Callout title="Subscription required" variant="warning">
  ...
  to our private registry](/3.x/guides/pro-extensions).
</Callout>
...
<div className="grid sm:grid-cols-2 gap-5">
  <ProductCard
    ...
    documentationUrl="/3.x/content-ai/capabilities/generation/overview"
  ...
  <ProductCard
    ...
    documentationUrl="/3.x/content-ai/capabilities/suggestion/overview"
    icon={contentAIIcon.src}
  />
</div>
...
- [AI Text Generation](/3.x/content-ai/capabilities/generation/overview)
- [AI Autocompletion](/3.x/content-ai/capabilities/generation/text-generation/autocompletion)
- [AI Suggestion](/3.x/content-ai/capabilities/suggestion/overview)

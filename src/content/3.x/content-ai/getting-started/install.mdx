...
Unless you’re an business customer who wants to use [custom resolver functions](/3.x/content-ai/custom-llms/integrate), you’ll need to set up your OpenAI keys in your [Tiptap account](https://cloud.tiptap.dev/ai-settings).
...
At this point you’re good to go to use OpenAI in your Tiptap editor. Have a look at the [configuration options](/3.x/content-ai/getting-started/configure) to customize your experience.

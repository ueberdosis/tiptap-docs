...
To see all other Content AI extension configuration option, head over to the [install](/3.x/content-ai/getting-started/install#configure-the-extension) page.

...
To see how these commands are used, check out the examples on the [overview](/3.x/content-ai/getting-started/overview) page.
...
| **Utility**                                                                                                              |
| [`aiAccept(options: AcceptOptions)`](/3.x/content-ai/capabilities/text-generation/manage-responses#aiaccept)             | [Accept the generated response](/3.x/content-ai/capabilities/text-generation/manage-responses), and insert it into the editor |
| [`aiReject(options: RejectOptions)`](/3.x/content-ai/capabilities/text-generation/manage-responses#aireject)             | [Reject the generated Response](/3.x/content-ai/capabilities/text-generation/manage-responses), resetting ai.storage state    |
| [`aiRegenerate(options: RegenerateOptions)`](/3.x/content-ai/capabilities/text-generation/manage-responses#airegenerate) | [Regenerate a response](/3.x/content-ai/capabilities/text-generation/manage-responses) using the same parameters              |
...
| `format`         | `'rich-text' \| 'plain-text'`                                          | `plain-text`    | Determines the [format](/3.x/content-ai/capabilities/text-generation/format) of how the model should respond                                                                                                               |
...
| `context`        | `Array<{ type: 'text', text: string} \| { type: 'url', url: string }>` | `[]`            | [Context](/3.x/content-ai/capabilities/text-generation/provide-context) to provide the model for generating a Response.                                                                                                    |

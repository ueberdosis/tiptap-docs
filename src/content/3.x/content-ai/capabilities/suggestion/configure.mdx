...
You can learn more about rules in this guide: [Define rules](/3.x/content-ai/capabilities/suggestion/features/define-rules)
...
To learn more about the data that a suggestion object should contain, check the [API reference](/3.x/content-ai/capabilities/suggestion/api-reference#proofreading-suggestions).
...
To learn how to show a popover when you select a suggestion, follow [this guide](/3.x/content-ai/capabilities/suggestion/features/display-suggestions#show-a-popover-when-you-select-a-suggestion).
...
You can learn to configure when to load suggestions in [this guide](/3.x/content-ai/capabilities/suggestion/features/configure-when-to-load-suggestions).
...
If you do not [provide your own backend](/3.x/content-ai/capabilities/suggestion/custom-llms), the AI Suggestion extension will use the Tiptap Content AI cloud to generate suggestions.
...
You will find a more comprehensive guide on how to integrate your own backend and LLMs [in this guide](/3.x/content-ai/capabilities/suggestion/custom-llms).

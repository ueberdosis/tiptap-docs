...
For more advanced styles, use the `getCustomSuggestionDecoration` [configuration option](/3.x/content-ai/capabilities/suggestion/configure#custom-suggestion-styles).
...
We recommend using the [Floating UI](https://floating-ui.com/) library to display the popover. You can see an example on how to do it [in the demo](/3.x/content-ai/capabilities/suggestion/overview).
...
You can access the current suggestions from the extension's [storage object](/3.x/content-ai/capabilities/suggestion/api-reference#extension-storage).

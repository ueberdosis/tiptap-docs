...
To learn more about the data that each suggestion object should contain, check the [API reference](/3.x/content-ai/capabilities/suggestion/api-reference#proofreading-suggestions).

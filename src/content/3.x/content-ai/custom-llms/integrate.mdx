...
meta:
  ...
  description: Implement custom LLMs with the AI extension and override resolver functions in your editor. Learn more in the docs!
  category: Content AI
---
...
<Callout title="Pro Extension" variant="warning">
    ...
    This extension requires a valid subscription in an eligible plan and [access to our private registry](/3.x/guides/pro-extensions), set this up first.

    **You need to be a business customer, to use the extension.**
...
If you want to rely on our cloud in some cases, make sure that you [setup your team as described here](/3.x/content-ai/getting-started/install#set-up-tiptap-ai-for-your-team).

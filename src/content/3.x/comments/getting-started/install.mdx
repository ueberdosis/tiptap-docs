...
<Callout title="Subscription required" variant="warning">
  This extension requires a valid subscription and a running [Tiptap Cloud
  instance](https://cloud.tiptap.dev/). To install the extension, you need [access to our private
  registry](/3.x/guides/pro-extensions).
</Callout>

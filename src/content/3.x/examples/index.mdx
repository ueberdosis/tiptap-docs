  ...
  <CardGrid.Wrapper className="sm:grid-cols-3">
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/default-text-editor">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/markdown-shortcuts">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/tables">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/images">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/formatting">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/tasks">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/long-texts">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/basics/minimal-setup">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor', 'Collaboration']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/collaborative-editing">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/menus">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/drawing">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/mentions">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/forced-content-structure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/clever-editor">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/interactive-react-and-vue-views">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/advanced/syntax-highlighting">
          <CardGrid.ItemImage
            asNextImage
...
<FilterGrid.Wrapper filters={['Editor', 'Collaboration']}>
  <CardGrid.Wrapper className="sm:grid-cols-3">
    <FilterGrid.Item filter={['Editor', 'Collaboration']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/collaborative-fields">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/figure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/generic-figure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/iframe">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/linting">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/slash-commands">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <Link href="/3.x/examples/experiments/trailing-node">
          <CardGrid.ItemImage
            asNextImage

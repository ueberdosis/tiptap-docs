...
It connects all clients to a WebSocket server and merges changes to the document with the power of [Y.js](https://github.com/yjs/yjs). If you want to learn more about collaborative text editing, check out [our installation guide on collaborative editing](/3.x/collaboration/getting-started/overview).

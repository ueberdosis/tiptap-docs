...
The [mentions extension](/3.x/editor/extensions/nodes/mention) allows you to create a text editor that supports mentions. This example shows you how to build a text editor with mentions using Tiptap.

...
Thanks to [node views](/3.x/editor/extensions/custom-extensions/node-views) you can add interactivity to your nodes. If you can write it in JavaScript, you can add it to the editor.

...
The following example shows how you can use [Tiptap Semantic Search](/3.x/collaboration/documents/semantic-search) to generate meaningful context for Tiptap AI.

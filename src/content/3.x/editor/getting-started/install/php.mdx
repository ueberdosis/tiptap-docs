...
We provide [an official PHP package to work with Tiptap content](/3.x/editor/api/utilities/tiptap-for-php). You can transform Tiptap-compatible JSON to HTML and vice versa, sanitize your content, or just modify it.

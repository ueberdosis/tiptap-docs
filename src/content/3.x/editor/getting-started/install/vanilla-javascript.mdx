...
<Callout title="Hint" variant="hint">
    If you don't use a bundler like Webpack or Rollup, please follow the [CDN](/3.x/editor/getting-started/install/cdn) guide instead. Since Tiptap is built in a modular way, you will need to use `<script type="module">` in your HTML to get our CDN imports working.
</Callout>

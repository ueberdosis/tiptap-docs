...
Learn how to integrate Tiptap with your SvelteKit project using this step-by-sep guide. Alternatively, check out our [Svelte text editor example](/3.x/examples/basics/default-text-editor).

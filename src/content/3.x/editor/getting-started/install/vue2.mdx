...
This guide details how to integrate Tiptap with your Vue 2 project. Alternatively, check out our [Vue text editor example](/3.x/examples/basics/default-text-editor).

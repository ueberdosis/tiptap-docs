...
<CardGrid.Wrapper className="grid-cols-1 sm:grid-cols-3">
  <CardGrid.Item asChild>
    <Link href="/3.x/editor/getting-started/install/vanilla-javascript">
  ...
  <CardGrid.Item asChild>
    <Link href="/3.x/editor/getting-started/install/react">
  ...
  <CardGrid.Item asChild>
    <Link href="/3.x/editor/getting-started/install/alpine">

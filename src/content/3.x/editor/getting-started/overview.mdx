...
Tiptap works across multiple frameworks, including React, Vue, Svelte, and more. Developers often use the vanilla JavaScript integration to adapt Tiptap to their preferred framework. [Learn how to integrate Tiptap with your framework](/3.x/editor/getting-started/install).
...
You can start with the [`StarterKit`](/3.x/editor/extensions/functionality/starterkit), which includes common extensions.

We provide a range of open-source and more sophisticated Pro extensions. For detailed instructions on using and creating extensions, visit our [extensions](/3.x/editor/core-concepts/extensions) and [custom extensions](/3.x/editor/extensions/custom-extensions) guides.
...
<CtaBox.Wrapper>
  ...
  <CtaBox.Actions className="-mx-3">
    <Button className="text-white/80 hover:text-white/100" variant="tertiary" asChild>
      <Link href="/3.x/collaboration/getting-started/overview">
        Learn more
...
<br />
<br />
<Section title="Editor resources" moreLink={{ label: 'Browse guides', url: '/3.x/guides' }}>
  <CardGrid.Wrapper>

...
1. [Create a mark extension](/3.x/editor/extensions/custom-extensions/create-new/mark)
2. Register a new mark view with `addMarkView()`
3. Write your render function
4. [Configure Tiptap to use your new mark extension](/3.x/editor/getting-started/configure)

...
They extend all of the options and methods from the [Extension API](/3.x/editor/extensions/custom-extensions/extension) and add a few more specific to marks.
...
For more details, see the [extend existing extensions](/3.x/editor/extensions/custom-extensions/extend-existing#rattributes) guide.

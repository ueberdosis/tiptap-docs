...
The content expression for this node, as described in the [schema guide](/3.x/guide/#schema.content_expressions). When not given, the node does not allow any content.

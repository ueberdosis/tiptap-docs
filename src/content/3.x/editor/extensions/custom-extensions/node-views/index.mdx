...
That’s how the [`TaskItem`](/3.x/editor/extensions/nodes/task-item) node works.
...
But what happens if you [access the editor content](/3.x/guides/output-json-html)? If you’re working with HTML, you’ll need to tell Tiptap how your node should be serialized.
...
Attributes are automagically restored, if you registered them through [`addAttributes`](/3.x/editor/extensions/custom-extensions/extend-existing#attributes).

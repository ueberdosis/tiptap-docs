...
This extension requires the [`DetailsSummary`](/3.x/editor/extensions/nodes/details-summary) and [`DetailsContent`](/3.x/editor/extensions/nodes/details-content) node.

...
Sets the given attribute for the current cell. Can be whatever you define on the [`TableCell`](/3.x/editor/extensions/nodes/table-cell) extension, for example a background color. Just make sure to register [your custom attribute](/3.x/editor/extensions/custom-extensions/extend-existing#attributes) first.

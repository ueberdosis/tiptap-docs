...
We also have an [Import extension](/3.x/editor/extensions/functionality/import), or you can review an example that does both import and export [over here](/3.x/collaboration/documents/conversion).

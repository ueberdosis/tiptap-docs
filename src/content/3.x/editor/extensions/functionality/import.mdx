...
We also have an [Export extension](/3.x/editor/extensions/functionality/export), or you can review an example that does both import and export [over here](/3.x/collaboration/documents/conversion).
...
<Callout title="Beta release" variant="hint">
  ...
  access to our [private registry](/3.x/guides/pro-extensions), set this up first.
</Callout>
...
| `imageUploadCallbackUrl` | `string`   | `undefined` | The URL to upload images to, if not provided, images will be stripped from the document, [see more info](/3.x/collaboration/documents/conversion#image-uploading)                               |
...
- [Conversion API Reference](/3.x/collaboration/documents/conversion)

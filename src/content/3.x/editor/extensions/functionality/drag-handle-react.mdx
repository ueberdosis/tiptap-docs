...
It essentially wraps the [DragHandle](/3.x/editor/extensions/functionality/drag-handle) extension in a React component that will automatically register/unregister the extension with the editor.
...
All props follow the same structure as the [DragHandle](/3.x/editor/extensions/functionality/drag-handle) extension.
...
See the [DragHandle](/3.x/editor/extensions/functionality/drag-handle) extension for available editor commands.

...
This extension will make a contextual menu appear near a selection of text. Use it to let users apply [marks](/3.x/editor/extensions/marks) to their text selection.

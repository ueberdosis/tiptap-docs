...
This extension enables you to set the font size in the editor. It uses the [`TextStyle`](/3.x/editor/extensions/marks/text-style) mark, which renders a `<span>` tag. The font size is applied as inline style, for example `<span style="font-size: 14px">`.

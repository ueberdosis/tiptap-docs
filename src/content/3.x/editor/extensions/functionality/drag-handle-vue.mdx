...
It essentially wraps the [DragHandle](/3.x/editor/extensions/functionality/drag-handle) extension in a vue component that will automatically register/unregister the extension with the editor.

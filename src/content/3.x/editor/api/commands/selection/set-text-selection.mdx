...
See also: [focus](/3.x/editor/api/commands/selection/focus), [setNodeSelection](/3.x/editor/api/commands/selection/set-node-selection), [deleteSelection](/3.x/editor/api/commands/selection/delete-selection), [selectAll](/3.x/editor/api/commands/selection/select-all)

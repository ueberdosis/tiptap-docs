...
- **Managing Focus and Blur:** Control focus behavior using [`focus`](/3.x/editor/api/commands/selection/focus) and [`blur`](/3.x/editor/api/commands/selection/blur).
- **Deleting and Selecting Content:** Use commands like [`deleteSelection`](/3.x/editor/api/commands/selection/delete-selection) and [`selectAll`](/3.x/editor/api/commands/selection/select-all) to efficiently manage content.
- **Navigating the Document:** Scroll to a specific position or node using [`scrollIntoView`](/3.x/editor/api/commands/selection/scroll-into-view) and select specific nodes with [`selectNodeBackward`](/3.x/editor/api/commands/selection/select-node-backward), [`selectNodeForward`](/3.x/editor/api/commands/selection/select-node-forward), or [`selectParentNode`](/3.x/editor/api/commands/selection/select-parent-node).

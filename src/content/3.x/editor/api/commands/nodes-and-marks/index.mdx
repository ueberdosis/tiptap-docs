...
- **Creating New Nodes:** Use [`createParagraphNear`](/3.x/editor/api/commands/nodes-and-marks/create-paragraph-near) or [`splitBlock`](/3.x/editor/api/commands/nodes-and-marks/split-block) to add new nodes near the selection.
- **Managing Node Structures:** Update, replace, or lift nodes using commands like [`setNode`](/3.x/editor/api/commands/nodes-and-marks/set-node), [`lift`](/3.x/editor/api/commands/nodes-and-marks/lift), or [`toggleNode`](/3.x/editor/api/commands/nodes-and-marks/toggle-node).
- **Mark Manipulation:** Toggle, set, or unset marks using commands like [`toggleMark`](/3.x/editor/api/commands/nodes-and-marks/toggle-mark), [`setMark`](/3.x/editor/api/commands/nodes-and-marks/set-mark), or [`unsetMark`](/3.x/editor/api/commands/nodes-and-marks/unset-mark).
- **Content Cleanup:** Remove unwanted marks or nodes using [`clearNodes`](/3.x/editor/api/commands/nodes-and-marks/clear-nodes), [`unsetAllMarks`](/3.x/editor/api/commands/nodes-and-marks/unset-all-marks), or [`resetAttributes`](/3.x/editor/api/commands/nodes-and-marks/reset-attributes).

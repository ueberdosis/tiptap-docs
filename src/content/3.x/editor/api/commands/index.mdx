...
For some of your own commands, you probably want to work with the raw [transaction](/3.x/editor/core-concepts/introduction). To make them work with `.can()` you should check if the transaction should be dispatched. Here is how you can create a simple `.insertText()` command:
...
All extensions can add additional commands (and most do), check out the specific [documentation for the provided nodes](/3.x/editor/extensions/nodes), [marks](/3.x/editor/extensions/marks), and [functionality](/3.x/editor/extensions/functionality) to learn more about those. And of course, you can [add your custom extensions](/3.x/editor/extensions/custom-extensions) with custom commands as well.

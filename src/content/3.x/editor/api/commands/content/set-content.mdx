...
See also: [insertContent](/3.x/editor/api/commands/content/insert-content), [clearContent](/3.x/editor/api/commands/content/clear-content)

## Parameters

### content

The new content as string (JSON or HTML), Fragment, or ProseMirror Node. The editor will only render what's allowed according to the [schema](/3.x/editor/core-concepts/schema).

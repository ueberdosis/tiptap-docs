...
This utility helps with all kinds of suggestions in the editor. Have a look at the [`Mention`](/3.x/editor/extensions/nodes/mention) or [`Emoji`](/3.x/editor/extensions/nodes/emoji) node to see it in action.

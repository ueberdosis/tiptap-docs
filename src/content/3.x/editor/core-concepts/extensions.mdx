...
To add new types of content into your editor you can use [nodes](/3.x/editor/api/nodes) and [marks](/3.x/editor/extensions/marks) which can render content in the editor.

The optional `@tiptap/starter-kit` includes the most commonly used extensions, simplifying setup. Read more about [`StarterKit`](/3.x/editor/getting-started/configure#default-extensions).
...
Learn more about custom extensions in our [guide](/3.x/editor/extensions/custom-extensions).

...
<div className="grid gap-20">
    <CtaBox.Wrapper>
        ...
        <CtaBox.Actions className="-mx-3">
            <Button className="text-white/80 hover:text-white/100" variant="tertiary" asChild>
                <VersionedLink href="/editor/getting-started/overview">
      ...
      <ImageCard.Content>
        ...
        <div className="flex items-center gap-2 mt-8">
            <Button asChild variant="secondary">
                <VersionedLink href="https://templates.tiptap.dev/">
                    Show demo
                    <ArrowRightIcon className="size-4" />
                </VersionedLink>
            </Button>
            <Button asChild variant="tertirary">
                <VersionedLink href="https://cloud.tiptap.dev/react-templates">
                    Get access
                    <ArrowRightIcon className="size-4" />
                </VersionedLink>
            </Button>
    ...
    <CtaBox.Wrapper variant="light" className="mt-12">
      ...
      <CtaBox.Actions className="-mx-3">
        <Button variant="tertiary" asChild>
          <VersionedLink href="https://cloud.tiptap.dev/register">
            Sign up now
            <ArrowRightIcon className="w-4 h-4" />
          </VersionedLink>
        </Button>
  ...
  <Section title="Examples" moreLink={{ label: 'Browse examples', url: '/examples' }}>
    <CardGrid.Wrapper>
  ...
  <Section title="Guides" moreLink={{ label: 'Browse guides', url: '/guides' }}>
    <CardGrid.Wrapper>
      <CardGrid.Item asChild>
          <VersionedLink href="/editor/getting-started/configure">
      ...
      <CardGrid.Item asChild>
          <VersionedLink href="/guides/pro-extensions">
          <CardGrid.Subtitle size="sm">First Steps</CardGrid.Subtitle>
          <div>
      ...
      <CardGrid.Item asChild>
          <VersionedLink href="/collaboration/getting-started/install">
          <CardGrid.Subtitle size="sm">First Steps</CardGrid.Subtitle>
          <div>
      ...
      <CardGrid.Item asChild>
          <VersionedLink href="/editor/getting-started/style-editor">
  ...
  <Section title="Community">
    <Grid.Wrapper className="sm:grid-cols-2 lg:grid-cols-3">
      <Grid.Item asChild>
        <VersionedLink href="https://x.com/tiptap_editor" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
      ...
      <Grid.Item asChild>
        <VersionedLink href="https://tiptap.dev/discord" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
      ...
      <Grid.Item asChild>
        <VersionedLink href="https://github.com/ueberdosis/tiptap" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>

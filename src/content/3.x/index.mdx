...
<div className="grid gap-20">
    <CtaBox.Wrapper>
        ...
        <CtaBox.Actions className="-mx-3">
            <Button className="text-white/80 hover:text-white/100" variant="tertiary" asChild>
                <Link href="/3.x/editor/getting-started/overview">
  ...
  >
    <div className="grid sm:grid-cols-2 gap-5">
      <ProductCard
        ...
        tags={["Open source"]}
        documentationUrl="/3.x/editor/getting-started/overview"
        secondaryUrl="/3.x/examples/basics/default-text-editor"
        icon={editorIcon.src}
      />
      <ProductCard
        title="Collaboration"
        ...
        documentationUrl="/3.x/collaboration/getting-started/overview"
        secondaryUrl="/3.x/collaboration/getting-started/install"
        icon={collabIcon.src}
      />
      <ProductCard
        title="Content AI"
        ...
        tags={["Cloud", "On premises"]}
        documentationUrl="/3.x/content-ai/getting-started/overview"
        secondaryUrl="/3.x/content-ai/capabilities/generation/overview#example"
      ...
      <ProductCard
        ...
        tags={["Cloud", "On premises"]}
        documentationUrl="/3.x/comments/getting-started/overview"
        secondaryUrl="/3.x/comments/getting-started/overview#comments-example"
      ...
      <ProductCard
        ...
        tags={["Cloud", "On premises"]}
        documentationUrl="/3.x/collaboration/documents"
        secondaryUrl="/3.x/collaboration/documents/rest-api"
  ...
  <Section title="Examples" moreLink={{ label: 'Browse examples', url: '/3.x/examples' }}>
    <CardGrid.Wrapper>
  ...
  <Section title="Guides" moreLink={{ label: 'Browse guides', url: '/3.x/guides' }}>
    <CardGrid.Wrapper>
      <CardGrid.Item asChild>
          <Link href="/3.x/editor/getting-started/configure">
      ...
      <CardGrid.Item asChild>
          <Link href="/3.x/guides/pro-extensions">
          <CardGrid.Subtitle size="sm">First Steps</CardGrid.Subtitle>
          <div>
      ...
      <CardGrid.Item asChild>
          <Link href="/3.x/collaboration/getting-started/install">
          <CardGrid.Subtitle size="sm">First Steps</CardGrid.Subtitle>
          <div>
      ...
      <CardGrid.Item asChild>
          <Link href="/3.x/editor/getting-started/style-editor">

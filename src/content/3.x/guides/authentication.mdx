...
For a quick setup guide, follow these instructions. For detailed information, visit the [Authentication](/3.x/collaboration/getting-started/authenticate) page.

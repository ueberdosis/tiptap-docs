...
We've consolidated a number of packages, so you may need to update your imports. But, luckily, we've written a codemod that will help you with this. Run the following command in your project:

```bash
npx codemod tiptap-2-migrate-imports
```

Some packages may have been removed or renamed, so you may need to update your dependencies. Here are some common changes:
...
- [CharacterCount](/3.x/editor/extensions/functionality/character-count)
- [Dropcursor](/3.x/editor/extensions/functionality/dropcursor)
- [Gapcursor](/3.x/editor/extensions/functionality/gapcursor)
- [History](/3.x/editor/extensions/functionality/undo-redo)
- [Placeholder](/3.x/editor/extensions/functionality/placeholder)
- [TrailingNode](/3.x/editor/extensions/functionality/trailing-node)
- [Focus](/3.x/editor/extensions/functionality/focus)
- [Selection](/3.x/editor/extensions/functionality/selection)
...
- [Link](/3.x/editor/extensions/marks/link)
- [ListKeymap](/3.x/editor/extensions/functionality/listkeymap)
- [Underline](/3.x/editor/extensions/marks/underline)

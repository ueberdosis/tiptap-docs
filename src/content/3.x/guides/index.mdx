...
<FilterGrid.Wrapper filters={['Editor', 'Collaboration']}>
  <CardGrid.Wrapper className="sm:grid-cols-3">
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/accessibility">
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/performance">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/invalid-schema">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/output-json-html">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
    ...
    <FilterGrid.Item filter="Collaboration">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/authentication">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
            <CardGrid.ItemTitle>
    ...
    <FilterGrid.Item filter="Collaboration">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/naming-documents">
    ...
    <FilterGrid.Item filter="Collaboration">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/offline-support">
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/upgrade-tiptap-v1">
          <CardGrid.Subtitle size="sm">Essential</CardGrid.Subtitle>
          <div>
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <Link href="/3.x/guides/typescript">

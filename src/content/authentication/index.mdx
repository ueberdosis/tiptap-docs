...
<Callout title="Not yet available for on-premises deployments" variant="warning" size="md">
  The authentication model described on this page is currently available on Tiptap Cloud only. If
  you run Tiptap on-premises, use [Legacy authentication](/authentication/legacy) instead. We're
  shipping the new authentication for on-premises deployments in September 2026.
</Callout>

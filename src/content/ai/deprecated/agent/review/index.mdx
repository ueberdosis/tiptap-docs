...
Configure a review workflow to give users more control over AI-generated content. The AI Agent extension integrates with the [AI Changes](/ai/deprecated/changes/overview) and [AI Suggestion](/ai/deprecated/suggestion/overview) extensions to help users approve, reject, and modify AI-generated content.

There are two ways of handling AI-generated changes:

- [**Review after applying**](/ai/deprecated/agent/review/ai-changes): Changes are applied to the document, and then reviewed with the **AI Changes** extension. Users can then accept or reject the changes. Rejecting a change will revert the document to its previous content. Follow [this guide](/ai/deprecated/agent/review/ai-changes) to configure.
- [**Preview before applying**](/ai/deprecated/agent/review/ai-suggestion): Changes are sent to the **AI Suggestion** extension, where users can review and approve or reject them before they are applied to the document. Follow [this guide](/ai/deprecated/agent/review/ai-suggestion) to configure.

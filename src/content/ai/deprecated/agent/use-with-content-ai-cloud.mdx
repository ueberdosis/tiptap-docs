...
meta:
  title: Use the AI Agent extension with Content AI Cloud | Tiptap Content AI
...
<Requirements>
  ...
  <RequirementItem label="2. Integrate an AI provider">
    ...
    [Custom AI agent guide](/ai/deprecated/agent/custom-llms/overview) to integrate it with other
    AI providers.
  </RequirementItem>
...
<Callout title="Note" variant="info">
  ...
  guide](/ai/deprecated/agent/custom-llms/overview) instead.
</Callout>

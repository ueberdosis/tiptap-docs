...
To activate selection awareness, set the `addSelection` option to `true`. This will send the selected content as [context](/ai/deprecated/agent/features/context) to the AI agent.

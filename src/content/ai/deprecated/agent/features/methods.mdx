...
| ------------------------------- | ------------------------------------------------------------------------------------ | -------------------------------- |
| `run()`                         | Starts a new AI agent [lifecycle](/ai/deprecated/agent/features/lifecycle) | None                             |
...
| `setSystemPrompt(systemPrompt)` | Sets the [system prompt](/ai/deprecated/agent/configure/system-prompt)     | `systemPrompt`: `string \| null` |
...
| `setAutoAccept(autoAccept)`         | Changes the [auto-accept](/ai/deprecated/agent/features/review#auto-accept-configuration) setting | `autoAccept`: `"always" \| "never" \| "onlyRead"`        |
| `setCheckpoint()`                   | Saves the current state as a [checkpoint](/ai/deprecated/agent/features/checkpoints)              | None                                                     |

...
3. In [your backend](/ai/deprecated/agent/custom-llms), define a [custom server-side tool](/ai/deprecated/agent/custom-llms/server-side-tools) that lets your AI agent read the contents of the file.

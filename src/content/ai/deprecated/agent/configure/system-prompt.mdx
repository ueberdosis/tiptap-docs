...
When using the AI Agent extension with a custom AI agent running in your backend, the way to customize the system prompt depends on the AI model provider you are using. Learn more in our [Custom AI agent integration guide](/ai/deprecated/agent/custom-llms/overview).

...
- [Use it with Tiptap Cloud](/ai/deprecated/agent/use-with-content-ai-cloud), which provides a managed, ready-to-use AI agent.
- [Add it to your existing AI agent](/ai/deprecated/agent/custom-llms/overview), that's hosted in your backend.

...
To learn more about the data that each suggestion object should contain, check the [API reference](/ai/deprecated/suggestion/api-reference#proofreading-suggestions).

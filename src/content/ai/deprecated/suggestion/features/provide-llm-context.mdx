...
When you [generate suggestions with Tiptap Content AI cloud](/ai/deprecated/suggestion/use-with-content-ai-cloud), the following information is sent to the LLM:

- The editor's content.
- The extension's [rules](/ai/deprecated/suggestion/features/define-rules).

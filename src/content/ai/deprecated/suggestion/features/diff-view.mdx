...
<Callout title="Note" variant="info">
  ...
  Changes](/ai/deprecated/changes/overview) extension.
</Callout>
...
Learn how to add advanced styles to suggestions in the [styling guide](/ai/deprecated/suggestion/features/display-suggestions).
...
Reviewing diff-based suggestions is done the same way as regular suggestions. See the [apply suggestions](/ai/deprecated/suggestion/features/apply-suggestions) guide for more information.

...
When using AI Suggestion with Tiptap Collaboration, suggestions are private to each user. This allows showing different suggestions based on user preferences or context. Once accepted, suggestions become visible to all connected users ([learn more](/ai/deprecated/resources/collaboration)).

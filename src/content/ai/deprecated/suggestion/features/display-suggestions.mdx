...
For more advanced styles, use the `getCustomSuggestionDecoration` [configuration option](/ai/deprecated/suggestion/configure#custom-suggestion-styles).
...
We recommend using the [Floating UI](https://floating-ui.com/) library to display the popover. You can see an example on how to do it [in the demo](/ai/deprecated/suggestion/overview).
...
You can access the current suggestions from the extension's [storage object](/ai/deprecated/suggestion/api-reference#extension-storage).

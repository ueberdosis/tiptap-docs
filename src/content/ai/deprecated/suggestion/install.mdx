...
meta:
  ...
  description: Install and configure the AI Suggestion extension to display real-time proofreading suggestions with customizable rules and styling.
  category: Content AI
---
...
The easiest way to get started with the AI Suggestion extension is to use Tiptap Content AI Cloud. Our API will generate suggestions from your rules and content. Follow this setup guide: [Use Tiptap Content AI Cloud](/ai/deprecated/suggestion/use-with-content-ai-cloud).

You can also use your own backend and LLMs to generate proofreading suggestions. You can find a guide here: [Integrate your own backend and LLMs](/ai/deprecated/suggestion/custom-llms).
...
You can customize the suggestions' appearance even more by providing custom decorations. To show a tooltip or a popover when you select a suggestion, [follow this guide](/ai/deprecated/suggestion/features/display-suggestions#show-a-popover-when-you-select-a-suggestion).

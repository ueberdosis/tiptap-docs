...
You can learn more about rules in this guide: [Define rules](/ai/deprecated/suggestion/features/define-rules)
...
To learn more about the data that a suggestion object should contain, check the [API reference](/ai/deprecated/suggestion/api-reference#proofreading-suggestions).
...
To learn how to show a popover when you select a suggestion, follow [this guide](/ai/deprecated/suggestion/features/display-suggestions#show-a-popover-when-you-select-a-suggestion).
...
You can learn to configure when to load suggestions in [this guide](/ai/deprecated/suggestion/features/configure-when-to-load-suggestions).
...
If you do not [provide your own backend](/ai/deprecated/suggestion/custom-llms), the AI Suggestion extension will use the Tiptap Content AI cloud to generate suggestions.
...
You will find a more comprehensive guide on how to integrate your own backend and LLMs [in this guide](/ai/deprecated/suggestion/custom-llms).
...
You can learn more about providing context in [this guide](/ai/deprecated/suggestion/features/provide-llm-context).

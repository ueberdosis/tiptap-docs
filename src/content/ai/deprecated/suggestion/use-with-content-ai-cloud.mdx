...
Learn how Tiptap processes AI requests and handles your content data in our [privacy documentation](/ai/basic/privacy). This covers data retention, security practices, and compliance information for using Content AI features.

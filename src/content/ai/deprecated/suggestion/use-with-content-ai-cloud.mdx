...
This installation guide relies on using the [Tiptap Content AI backend service](https://cloud.tiptap.dev/v2/cloud/ai), if you want to configure it with your own custom LLM you need to follow [this guide](/ai/deprecated/suggestion/custom-llms) instead.

...
The most common pattern is to call `startTrackingAiChanges` immediately before generating AI content. This allows you to capture all AI-generated changes for review. For example, you can chain it with the [AI Generation extension commands](/ai/basic/text-generation/built-in-commands):

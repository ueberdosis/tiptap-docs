---
title: Autocompletion in AIBasicTerm
tags:
  - type: start
meta:
  title: Autocompletion | Tiptap AIBasicTerm
...
When you're integrating the AIBasicTerm extension you can specify that you want to enable autocompletion,
...
To see all other AIBasicTerm extension configuration option, head over to the [install](/ai/simple-generation/install#configure-the-extension) page.

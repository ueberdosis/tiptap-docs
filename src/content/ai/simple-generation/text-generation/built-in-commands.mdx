...
tags:
  - type: start
meta:
  title: AI Generation editor commands | Tiptap AIBasicTerm
...
<Requirements>
  ...
  <RequirementItem label="2. Integrate an AI provider">
    ...
    [Custom LLM guides](/ai/simple-generation/custom-llms).
  </RequirementItem>
...
To see how these commands are used, check out the examples on the [overview](/ai/simple-generation/overview) page.
...
| **Utility**                                                                                                                     |
| [`aiAccept(options: AcceptOptions)`](/ai/simple-generation/text-generation/manage-responses#aiaccept)             | [Accept the generated response](/ai/simple-generation/text-generation/manage-responses), and insert it into the editor |
| [`aiReject(options: RejectOptions)`](/ai/simple-generation/text-generation/manage-responses#aireject)             | [Reject the generated Response](/ai/simple-generation/text-generation/manage-responses), resetting ai.storage state    |
| [`aiRegenerate(options: RegenerateOptions)`](/ai/simple-generation/text-generation/manage-responses#airegenerate) | [Regenerate a response](/ai/simple-generation/text-generation/manage-responses) using the same parameters              |
...
| `format`         | `'rich-text' \| 'plain-text'`                                          | `plain-text`                                  | Determines the [format](/ai/simple-generation/text-generation/format) of how the model should respond                                                                                                        |
...
| `context`        | `Array<{ type: 'text', text: string} \| { type: 'url', url: string }>` | `[]`                                          | [Context](/ai/simple-generation/text-generation/provide-context) to provide the model for generating a Response.                                                                                             |

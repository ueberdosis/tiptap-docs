...
meta:
  title: Custom LLM | Tiptap AIBasicTerm
  description: Implement custom LLMs with the AIBasicTerm extension and override resolver functions in your editor. Learn more in the docs!
...
If you want to rely on our cloud in some cases, make sure that you [setup your team as described here](/ai/simple-generation/install#start-your-content-ai-app).

---
title: Autocompletion in Basic AI Generation
tags:
  - type: start
meta:
  title: Autocompletion | Tiptap Basic AI Generation
...
When you're integrating the Basic AI Generation extension you can specify that you want to enable autocompletion,
...
To see all other Basic AI Generation extension configuration option, head over to the [install](/ai/basic/install#configure-the-extension) page.
...
When using autocompletion with [Tiptap Collaboration](/collaboration/getting-started/overview), suggestions are private to each user and only become visible to others once accepted.

...
The AI Generation extension provides a list of [built-in commands](/ai/basic/text-generation/built-in-commands), but you can extend it to define your own. These custom commands can be used to call the LLM with your custom prompt.

...
meta:
  title: Custom LLM | Tiptap Basic AI Generation
  description: Implement custom LLMs with the Basic AI Generation extension and override resolver functions in your editor. Learn more in the docs!
...
If you want to rely on our cloud in some cases, make sure that you [setup your team as described here](/ai/basic/install#start-your-content-ai-app).
...
const editor = new Editor({
  extensions: [
    ...
    AiExtended.configure({
      /* … add configuration here (token etc.) */
      onError(error, context) {
        // handle error
      },
      aiCompletionResolver: async ({

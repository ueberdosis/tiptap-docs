...
[Tiptap Shorthand](/ai/ai-toolkit/advanced-guides/tiptap-shorthand) (alpha) is a token-efficient format used for encoding Tiptap documents. It reduces AI token costs by up to 50% without sacrificing accuracy.

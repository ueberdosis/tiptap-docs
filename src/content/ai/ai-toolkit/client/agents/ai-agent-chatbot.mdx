...
Create an API endpoint that uses the [Vercel AI SDK](https://ai-sdk.dev/) to call the OpenAI model. Include the [tool definitions](/ai/ai-toolkit/client/tools/ai-sdk) for the Tiptap AI Toolkit.
...
When the AI model receives a request, it will decide to call the available tools to read the document and edit it. See the [list of available tools](/ai/ai-toolkit/client/tools/available-tools) for more details.

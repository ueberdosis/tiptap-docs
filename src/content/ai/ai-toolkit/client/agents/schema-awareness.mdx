...
Integrate the schema awareness feature to an AI agent like the one built in the [AI agent chatbot guide](/ai/ai-toolkit/client/agents/ai-agent-chatbot).
...
Alternatively, you can configure the `customNodes` option of the `getHtmlSchemaAwareness` method. Learn more about the configuration options in the [API Reference](/ai/ai-toolkit/client/api-reference/schema-awareness#gethtmlschemaawareness).
...
The code below shows an API endpoint built with Next.js and the Vercel AI SDK, like the one in the [AI agent chatbot guide](/ai/ai-toolkit/client/agents/ai-agent-chatbot).
...
The app below is a variant of the [AI agent chatbot demo](/ai/ai-toolkit/client/agents/ai-agent-chatbot) with schema awareness configured. Try asking the AI to create an alert box: the AI will recognize the custom element and insert it into the document.
...
- [Schema awareness API reference](/ai/ai-toolkit/client/api-reference/schema-awareness)

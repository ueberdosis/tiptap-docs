...
- `range` (`Range`): This is the position of the suggestion. It has a `from` property (the place where the suggestion starts) and a `to` property (the place where the suggestion ends). Learn more about ranges in the [Concepts guide](/ai/ai-toolkit/client/advanced-guides/concepts).
- The content that the AI suggests inserting into that `range`. This content is stored in the `replacementOptions` property.

See all the properties of the `Suggestion` object in the [API reference](/ai/ai-toolkit/client/api-reference/suggestions).
...
Suggestions are generated when you call a method of the AI Toolkit that [edits the document](/ai/ai-toolkit/client/api-reference/edit-the-document).
...
The diff utility has other options, learn about them in the [API reference](/ai/ai-toolkit/client/api-reference/diff-utility).
...
Suggestions can be read and updated programmatically. See the [API reference](/ai/ai-toolkit/client/api-reference/suggestions) for all available methods.

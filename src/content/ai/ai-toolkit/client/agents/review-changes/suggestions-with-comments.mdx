...
meta:
  title: Suggestions with comments | Tiptap AIUmbrellaTerm
...
<Callout title="Continuation from the suggestions guide" variant="info">
  This guide continues the [suggestions
  guide](/content-ai/capabilities/ai-toolkit/agents/review-changes/suggestions). Read it first.
</Callout>

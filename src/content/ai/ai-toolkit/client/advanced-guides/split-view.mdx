...
title: Split view
meta:
  title: Split view | Tiptap AIUmbrellaTerm
...
- [Split view API reference](/ai/ai-toolkit/client/api-reference/split-view)
- [Compare documents](/ai/ai-toolkit/client/advanced-guides/compare-documents): for the inline single-editor approach

...
The AI Toolkit methods allow you to [read](/ai/ai-toolkit/client/api-reference/read-the-document) and [edit](/ai/ai-toolkit/client/api-reference/edit-the-document) the document at specific positions.
...
A suggestion represents a proposed change to the document. When the AI makes a change to the document, you can show it as a suggestion so that the user can review and accept or reject it. Learn more in the [Review UI guide](/ai/ai-toolkit/client/agents/review-changes).
...
Tiptap Edit is available as a [tool](/ai/ai-toolkit/client/agents/tools) for AI agents to use. It is also available as a [workflow](/ai/ai-toolkit/client/workflows/tiptap-edit).

For Tiptap Edit to work, you need to read the document with Tiptap Read first. Tiptap Read is available as a [tool](/ai/ai-toolkit/client/agents/tools) for AI agents to use, or as a [workflow](/ai/ai-toolkit/client/workflows/tiptap-edit).

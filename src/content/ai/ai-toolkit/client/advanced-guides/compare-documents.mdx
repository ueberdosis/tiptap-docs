...
meta:
  title: Compare documents | Tiptap AI Toolkit
...
The diff is displayed as [suggestions](/ai/ai-toolkit/client/api-reference/suggestions) in the editor. Add this CSS file to your app to format suggestions as a red and green diff:
...
Call `getSuggestions` to get a list of changes between the documents, stored as [suggestions](/ai/ai-toolkit/client/api-reference/suggestions).
...
<CodeDemo isPro isLarge path="/Extensions/AiToolkitCompareDocuments" />

## Next steps

- [Compare documents API reference](/ai/ai-toolkit/client/api-reference/diff-utility)

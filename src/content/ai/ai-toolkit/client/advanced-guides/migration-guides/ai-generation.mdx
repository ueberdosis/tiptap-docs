---
title: Migrate from Basic AI Generation to the AI Toolkit
meta:
  title: Migrate from Basic AI Generation to the AI Toolkit | Tiptap AI Toolkit
  description: Migrate from Basic AI Generation to the AI Toolkit to gain full control over AI providers, custom backends, and advanced review workflows.
  category: AI Toolkit
---

The Basic AI Generation extension allows you to select content and ask the AI model to rewrite it based on your instructions.

To implement the same functionality with the AI Toolkit, follow the [Insert Content workflow](/ai/ai-toolkit/client/workflows/insert-content).

## Step 1: Server-side setup

The Basic AI Generation extension works out of the box with [Tiptap Cloud](https://cloud.tiptap.dev/v2/cloud/ai).
...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    instructions: `You are an expert writer that can edit rich text documents.
...
Learn more about review options in the [review changes guide](/ai/ai-toolkit/client/agents/review-changes) and in the [API reference](/ai/ai-toolkit/client/api-reference/edit-the-document#streamhtml) of the `streamHtml` method.
...
- See a demo of how to implement inline edits with the AI Toolkit in the [Insert Content workflow](/ai/ai-toolkit/client/workflows/insert-content).
- Build an AI assistant that can edit Tiptap documents in the [AI agent chatbot guide](/ai/ai-toolkit/client/agents/ai-agent-chatbot).

...
The Basic AI Generation extension allows you to select content and ask AI model to re-write it based on your instructions.

To implement the same functionality with the AI Toolkit, the recommend path is to follow the [Insert Content workflow](/ai/ai-toolkit/client/workflows/insert-content).

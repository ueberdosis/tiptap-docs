...
meta:
  title: Tiptap Edit workflow | Tiptap AI Toolkit
...
```bash
npm install @tiptap-pro/client-ai-toolkit @tiptap-pro/client-ai-toolkit-tool-definitions
```
...
import { createTiptapEditWorkflow } from '@tiptap-pro/client-ai-toolkit-tool-definitions'
...
See the [AI Caret guide](/ai/ai-toolkit/client/advanced-guides/ai-caret) for configuration options and CSS styles.

## Edit part of the document

To edit only a sub-section of the document, set the `range` option. This argument takes a [Range](/ai/ai-toolkit/client/advanced-guides/concepts#range) with the region to edit.
...
For large documents, you can use the [`tiptapReadChunks`](/ai/ai-toolkit/client/api-reference/read-the-document#tiptapreadchunks) method to split the document into chunks and process them in parallel. Each chunk includes a [Range](/ai/ai-toolkit/client/advanced-guides/concepts#range) with the region of that chunk.
...
See the [review changes](/ai/ai-toolkit/client/agents/review-changes) guide to learn more about the review UI.
...
- [API reference](/ai/ai-toolkit/client/api-reference/read-the-document#tiptapread) of the `tiptapRead` method
- [API reference](/ai/ai-toolkit/client/api-reference/read-the-document#tiptapreadchunks) of the `tiptapReadChunks` method
- [API reference](/ai/ai-toolkit/client/api-reference/workflows#tiptapeditworkflow) of the `tiptapEditWorkflow` method
- [Suggestions](/ai/ai-toolkit/client/agents/review-changes): Learn about reviewing the document and displaying suggestions in the editor.
- [AI Caret](/ai/ai-toolkit/client/advanced-guides/ai-caret): Show a cursor where the AI is inserting content.

...
To edit only a sub-section of the document, set the `range` option. This argument takes a [Range](/content-ai/capabilities/ai-toolkit/advanced-guides/concepts#range) with the region to edit.

...
meta:
  title: Build a template workflow with the AI Toolkit | Tiptap AI Toolkit
...
<Callout title="Deprecated" variant="warning">
  If your use case involves templates and slot-filling, please [email us](mailto:humans@tiptap.dev).
</Callout>
...
To insert the template result into a specific region instead of replacing the entire document, set the `position` option. It takes either a position or a [Range](/ai/ai-toolkit/client/advanced-guides/concepts#range).
...
<CodeDemo isLarge path="/Extensions/AiToolkitTemplateEditor/" isScrollable />
...
- [API reference](/ai/ai-toolkit/client/api-reference/workflows#templateworkflow) of the `templateWorkflow` method
- [API reference](/ai/ai-toolkit/client/api-reference/workflows#createhtmltemplate) of the `createHtmlTemplate` method
- [API reference](/ai/ai-toolkit/client/api-reference/workflows#createtemplateworkflow-server-side-utility) of the `createTemplateWorkflow` utility

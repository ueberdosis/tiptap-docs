...
In [AI agents](/ai/ai-toolkit/client/agents), the AI model can choose from a set of tools to perform a task. Workflows, on the other hand, only allow the AI model to perform a single action, such as generating edits or rewriting the document.

...
meta:
  title: Build a proofreader with the AI Toolkit | Tiptap AI Toolkit
...
import { AiToolkit, getAiToolkit, proofreaderWorkflowOutputSchema } from '@tiptap-pro/client-ai-toolkit'
...
To proofread a sub-section of the document, set the `range` option. This argument takes a [Range](/ai/ai-toolkit/client/advanced-guides/concepts#range) with the region where the document will be proofread.
...
- [API reference](/ai/ai-toolkit/client/api-reference/workflows#proofreaderworkflow) of the `proofreaderWorkflow` method

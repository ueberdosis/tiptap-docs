...
The AI Toolkit provides a set of methods that are the building blocks for your AI integrations. You can call these methods from the AI Toolkit instance:

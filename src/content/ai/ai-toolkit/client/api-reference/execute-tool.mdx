...
meta:
  title: Execute tool (AI agents) | Tiptap AI Toolkit
...
Once you've added [tool definitions](/ai/ai-toolkit/client/agents/tools) to your AI agent, the AI agent will generate tool calls. Use the `executeTool` method to apply the tool calls to the editor.

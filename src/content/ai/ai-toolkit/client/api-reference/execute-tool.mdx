...
meta:
  title: Execute tool (AI agents) | Tiptap AIUmbrellaTerm
...
Once you've added [tool definitions](/ai/ai-toolkit/client/tools) to your AI agent, the AI agent will generate tool calls. Use the `executeTool` method to apply the tool calls to the editor.
...
- `toolName` (`string`): Tool to execute. Can be one of the [available tools](/ai/ai-toolkit/client/agents/tools).
...
- `tiptapEditHooks?` (`TiptapEditHooks`): Hooks for intercepting and modifying Tiptap Edit operations. See the [Tiptap Edit hooks guide](/ai/ai-toolkit/client/advanced-guides/tiptap-edit-hooks) for details.
...
For a complete hands-on tutorial, see the [AI agent chatbot guide](/ai/ai-toolkit/client/agents/ai-agent-chatbot).
...
For a complete hands-on tutorial on streaming, see the [streaming guide](/ai/ai-toolkit/client/agents/streaming).

...
meta:
  title: Review options | Tiptap AIUmbrellaTerm
  description: Configure preview and review behavior for AI-generated changes with ReviewOptions.
  category: AIUmbrellaTerm
---

All AI Toolkit methods that [edit the document](/ai/ai-toolkit/client/api-reference/edit-the-document) have a `reviewOptions` property. When configured, it allows you to display a review UI after the document is edited.
...
After editing the document, a list of [suggestions](/ai/ai-toolkit/client/agents/review-changes) will be displayed.
...
- `displayOptions?` (`DisplayOptions`): Customize how suggestions are displayed in the editor UI. Sets the `displayOptions` property of the [`Suggestion`](/ai/ai-toolkit/client/api-reference/suggestions#the-suggestion-object) type. [See available options](/ai/ai-toolkit/client/api-reference/suggestions#the-suggestion-object).

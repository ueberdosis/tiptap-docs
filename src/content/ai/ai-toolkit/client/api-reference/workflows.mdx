...
- [Insert content](/ai/ai-toolkit/client/workflows/insert-content).
- [Proofreader](/ai/ai-toolkit/client/workflows/proofreader).
- [Tiptap Edit](/ai/ai-toolkit/client/workflows/tiptap-edit).
- [Comments](/ai/ai-toolkit/client/workflows/comments).
- [Template](/ai/ai-toolkit/client/workflows/template).
...
- `options` (`ProofreaderWorkflowOptions`): Configuration options
  ...
  - `reviewOptions?` ([`ReviewOptions`](/ai/ai-toolkit/client/api-reference/review-options)): Control preview/review behavior. [See available options](/ai/ai-toolkit/client/api-reference/review-options).
...
- `options` (`TiptapEditWorkflowOptions`): Configuration options
  ...
  - `reviewOptions?` ([`ReviewOptions`](/ai/ai-toolkit/client/api-reference/review-options)): Control preview/review behavior.
    - `mode: 'trackedChanges'` is supported when the [Tracked Changes](/tracked-changes/getting-started/overview) extension is installed.
  ...
  - `tiptapEditHooks?` (`TiptapEditHooks`): Hooks for intercepting and modifying operations. See the [Tiptap Edit hooks guide](/ai/ai-toolkit/client/advanced-guides/tiptap-edit-hooks) for details.
...
const operations = await callApiEndpoint({
  content: readResult.content,
  task: 'Make the text more formal',
})
...
```ts
import { createEditThreadsWorkflow } from '@tiptap-pro/client-ai-toolkit-tool-definitions'
import { Output, streamText } from 'ai'
import { openai } from '@ai-sdk/openai'
...
```ts
import { TemplateField } from '@tiptap-pro/client-ai-toolkit'
...
```ts
import { getTemplateFieldMatches } from '@tiptap-pro/client-ai-toolkit'

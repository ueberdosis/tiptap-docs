...
title: Split view
meta:
  title: Split view API reference | Tiptap AIUmbrellaTerm
...
If you're new to the split view, start with the [split view guide](/ai/ai-toolkit/client/advanced-guides/split-view).

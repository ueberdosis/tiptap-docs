...
<Callout title="Coming soon" variant="info">
  ...
  Toolkit](/ai/ai-toolkit/client/agents/streaming) to stream AI-generated content in
...
Until server-side streaming is available, you can use the [AI Toolkit's streaming feature](/ai/ai-toolkit/client/agents/streaming) to achieve real-time updates. The AI Toolkit runs on the client side and supports streaming today via the `streamTool` method.

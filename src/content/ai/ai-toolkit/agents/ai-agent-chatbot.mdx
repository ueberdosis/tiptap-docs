  ...
  const tools = Object.fromEntries(
    toolDefinitions.map((toolDef) => [
      ...
      tool({
        ...
        // Set `strict: false` to disable the AI provider's
        // Structured Outputs option. In some AI providers,
        // the Structured Outputs feature does not allow
        // the AI to generate Tiptap JSON content.
        strict: false,
        execute: async (input) => {
          try {

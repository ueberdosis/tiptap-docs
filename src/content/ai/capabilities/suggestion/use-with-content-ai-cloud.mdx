...
3. **Set up authentication**: Sign a token with `aud: "AI"` and the `AI:Generation` permission, then pass it to the extension. See [Authentication](/authentication).

## Add Your Authentication Credentials to the Extension

Import the extension and configure it with your signed token.
...
Learn how Tiptap processes AI requests and handles your content data in our [privacy documentation](/content-ai/resources/privacy). This covers data retention, security practices, and compliance information for using Content AI features.

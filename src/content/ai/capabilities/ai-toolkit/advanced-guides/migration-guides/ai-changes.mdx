...
meta:
  title: Migrate from AI Changes to the AI Toolkit | Tiptap AIUmbrellaTerm
...
To integrate it in your app, follow the [Compare documents guide](/content-ai/capabilities/ai-toolkit/advanced-guides/compare-documents).

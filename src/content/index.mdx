...
import CloudIcon from '@/assets/images/cloud.svg?url'
...
import DedicatedCloudIcon from '@/assets/images/dedicated-cloud.svg?url'
import DiscordIcon from '@/assets/images/discord.svg?url'
import documentsIcon from '@/assets/documents.png'
import editorIcon from '@/assets/editor.png'
import GithubIcon from '@/assets/images/github.svg?url'
import OnPremisesIcon from '@/assets/images/self-hosted.svg?url'
...
<div className="grid gap-20">
  ...
  >
    <div className="grid sm:grid-cols-2 gap-5">
      ...
      <ProductCard
        title="AI Generation"
        description="Smart autocompletion, custom commands, and image generation with OpenAI or your own LLM."
        tags={["Custom LLM", "Cloud"]}
        documentationUrl="/ai/simple-generation/overview"
        secondaryUrl="/ai/simple-generation/overview#example"
        secondaryButtonText="View example"
        icon={aiGenerationIcon.src}
      />
      <ProductCard
        title="AI Toolkit"
        description="Build AI agents that can read, insert, and edit documents with tool definitions or primitives."
        tags={["Custom LLM"]}
        documentationUrl="/ai/ai-toolkit/client/overview"
        secondaryUrl="/ai/ai-toolkit/client/live-demo"
        secondaryButtonText="View demo"
        icon={aiToolkitIcon.src}
      />
      <ProductCard
        title="Server AI Toolkit"
        description="Build AI agents that read and edit documents on the server without a browser environment."
        tags={["Custom LLM"]}
...
>
  <Grid.Wrapper className="sm:grid-cols-2 lg:grid-cols-3">
    <Grid.Item>
      <Grid.ItemHeader>
        <img src={CloudIcon.src} alt="" aria-hidden="true" className="w-6 h-6" />
      </Grid.ItemHeader>
      <Grid.ItemContent>
    ...
    <Grid.Item>
      <Grid.ItemHeader>
        <img src={DedicatedCloudIcon.src} alt="" aria-hidden="true" className="w-6 h-6" />
      </Grid.ItemHeader>
      <Grid.ItemContent>
    ...
    <Grid.Item>
      <Grid.ItemHeader>
        <img src={OnPremisesIcon.src} alt="" aria-hidden="true" className="w-6 h-6" />
      </Grid.ItemHeader>
      <Grid.ItemContent>
    ...
    <Grid.Wrapper className="sm:grid-cols-2 lg:grid-cols-3">
      <Grid.Item asChild>
        <Link href="https://x.com/tiptap_editor" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <img src={XIcon.src} alt="" aria-hidden="true" className="w-6 h-6" />
          </Grid.ItemHeader>
          <Grid.ItemContent>
      ...
      <Grid.Item asChild>
        <Link href="https://tiptap.dev/discord" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <img src={DiscordIcon.src} alt="" aria-hidden="true" className="size-6" />
          </Grid.ItemHeader>
          <Grid.ItemContent>
      ...
      <Grid.Item asChild>
        <Link href="https://github.com/ueberdosis/tiptap" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <img src={GithubIcon.src} alt="" aria-hidden="true" className="w-6 h-6" />
          </Grid.ItemHeader>
          <Grid.ItemContent>

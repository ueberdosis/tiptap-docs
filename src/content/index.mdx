    ...
    <Grid.Wrapper className="sm:grid-cols-2 lg:grid-cols-3">
      <Grid.Item asChild>
        <Link href="https://x.com/tiptap_editor" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <XIcon aria-hidden="true" className="w-6 h-6 text-foreground" />
          </Grid.ItemHeader>
          <Grid.ItemContent>
      ...
      <Grid.Item asChild>
        <Link href="https://tiptap.dev/discord" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <DiscordIcon aria-hidden="true" className="size-6 text-foreground" />
          </Grid.ItemHeader>
          <Grid.ItemContent>
      ...
      <Grid.Item asChild>
        <Link href="https://github.com/ueberdosis/tiptap" target="_blank" rel="nofollow noreferrer">
          <Grid.ItemHeader>
            <GithubIcon aria-hidden="true" className="w-6 h-6 text-foreground" />
          </Grid.ItemHeader>
          <Grid.ItemContent>

...
>
  <Grid.Wrapper className="sm:grid-cols-2 lg:grid-cols-3">
    <Grid.Item>
      <Grid.ItemHeader>
        <CloudIcon aria-hidden="true" className="w-6 h-6 text-foreground" />
      </Grid.ItemHeader>
      <Grid.ItemContent>
    ...
    <Grid.Item>
      <Grid.ItemHeader>
        <DedicatedCloudIcon aria-hidden="true" className="w-6 h-6 text-foreground" />
      </Grid.ItemHeader>
      <Grid.ItemContent>
    ...
    <Grid.Item>
      <Grid.ItemHeader>
        <OnPremisesIcon aria-hidden="true" className="w-6 h-6 text-foreground" />
      </Grid.ItemHeader>
      <Grid.ItemContent>

  ...
  <CardGrid.Wrapper className="sm:grid-cols-3">
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/default-text-editor">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/markdown-shortcuts">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/tables">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/images">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/formatting">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/tasks">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/long-texts">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter="Editor">
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/basics/minimal-setup">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor', 'Collaboration']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/collaborative-editing">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/menus">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/drawing">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/mentions">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/forced-content-structure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/clever-editor">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/interactive-react-and-vue-views">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/advanced/syntax-highlighting">
          <CardGrid.ItemImage
            asNextImage
...
<FilterGrid.Wrapper filters={['Editor', 'Collaboration']}>
  <CardGrid.Wrapper className="sm:grid-cols-3">
    <FilterGrid.Item filter={['Editor', 'Collaboration']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/collaborative-fields">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/figure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/generic-figure">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/iframe">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/linting">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/slash-commands">
          <CardGrid.ItemImage
            asNextImage
    ...
    <FilterGrid.Item filter={['Editor']}>
      <CardGrid.Item asChild>
        <VersionedLink href="/examples/experiments/trailing-node">
          <CardGrid.ItemImage
            asNextImage

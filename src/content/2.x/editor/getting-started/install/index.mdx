...
<CardGrid.Wrapper className="grid-cols-1 sm:grid-cols-3">
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/getting-started/install/vanilla-javascript">
  ...
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/getting-started/install/react">
  ...
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/getting-started/install/alpine">
...
<CardGrid.Wrapper className="grid-cols-1 sm:grid-cols-3">
  <CardGrid.Item asChild>
    <VersionedLink
      ...
      href="https://github.com/sibiraj-s/ngx-tiptap"
    >
  ...
  <CardGrid.Item asChild>
    <VersionedLink
      target="_blank"
      rel="nofollow noreferrer"
      href="https://github.com/LXSMNSYC/solid-tiptap"
    >

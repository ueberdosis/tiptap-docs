...
<CardGrid.Wrapper className="sm:grid-cols-3">
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/extensions/custom-extensions/extend-existing">
  ...
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/extensions/custom-extensions/create-new">
  ...
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/extensions/custom-extensions/node-views">
  ...
  <CardGrid.Item asChild>
    <VersionedLink href="/editor/extensions/custom-extensions/node-views/examples">

...
Evaluated once at its owner. Findings may target only declared fields. See [custom validators](/blocks/slots/api-reference/validation#slotvalidator).
...
See [`validateSlotConfig`](/blocks/slots/api-reference/validation#validateslotconfig) to check configuration before assigning it.

...
**_Would you like to add a template or UI components to your project?_**
...
<Callout title="Skip component setup if already included" variant="info">
  If you added a template or UI components during setup, you can skip the **Add Tiptap Components**
  section and proceed directly t**o Add Styles.**
</Callout>

...
A fully accessible color text popover for Tiptap editors. Apply foreground and background colors to selected text with keyboard shortcut support and flexible customization options.

...
```bash
npx @tiptap/cli add improve-dropdown
```

## Manual Integration

Manually add from the [open-source repository](https://github.com/ueberdosis/tiptap-ui-components/tree/main/apps/web/src/components/tiptap-ui/improve-dropdown).
...
import { TIPTAP_AI_APP_ID, TIPTAP_AI_BASE_URL } from '@/lib/tiptap-collab-utils'

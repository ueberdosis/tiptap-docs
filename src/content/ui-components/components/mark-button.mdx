...
```tsx
import { canToggleMark } from '@/registry/tiptap-ui/mark-button'
...
```tsx
import { toggleMark } from '@/registry/tiptap-ui/mark-button'
...
```tsx
import { isMarkActive } from '@/registry/tiptap-ui/mark-button'
...
```tsx
import { getFormattedMarkName } from '@/registry/tiptap-ui/mark-button'

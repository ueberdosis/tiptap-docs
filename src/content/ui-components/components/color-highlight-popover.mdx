...
Selects specific highlight colors from the built-in palette by their CSS values.

```tsx
import {
  pickHighlightColorsByValue,
  HIGHLIGHT_COLORS,
} from '@/registry/tiptap-ui/color-highlight-button'

// Select specific colors
const essentialColors = pickHighlightColorsByValue([
...
const allColors = HIGHLIGHT_COLORS
```

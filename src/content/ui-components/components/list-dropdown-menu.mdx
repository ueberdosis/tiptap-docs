...
Manually add from the [open-source repository](https://github.com/ueberdosis/tiptap-ui-components/tree/main/apps/web/src/components/tiptap-ui/list-dropdown-menu).
...
```tsx
import { canToggleAnyList } from '@/registry/tiptap-ui/list-dropdown-menu'
...
```tsx
import { isAnyListActive } from '@/registry/tiptap-ui/list-dropdown-menu'
...
```tsx
import { getFilteredListOptions } from '@/registry/tiptap-ui/list-dropdown-menu'

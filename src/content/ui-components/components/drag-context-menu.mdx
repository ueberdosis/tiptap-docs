...
For starter, here’s a minimal set of extensions to get the DragContextMenu working:
...
You should able to see the drag handle on hover and open the context menu by clicking it.
...
| ------------------------- | ---------------- | -------- | ---------------------------------------------------------- |
| `editor`                  | `Editor \| null` | Required | Your Tiptap editor instance                                |

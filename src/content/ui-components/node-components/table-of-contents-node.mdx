...
import { TocSidebar } from '@/components/tiptap-node/toc-node/ui/toc-sidebar'
import { TocShowTitleButton } from '@/components/tiptap-node/toc-node/ui/toc-show-title-button'
...
```bash
# Using npm
npm install @tiptap/core @tiptap/react @tiptap/extension-table-of-contents @tiptap/extension-heading

# Using pnpm
pnpm add @tiptap/core @tiptap/react @tiptap/extension-table-of-contents @tiptap/extension-heading

# Using yarn
yarn add @tiptap/core @tiptap/react @tiptap/extension-table-of-contents @tiptap/extension-heading
```

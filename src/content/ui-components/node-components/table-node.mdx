...
```tsx
import { TableTriggerButton } from '@/registry/tiptap-node/table-node/ui/table-trigger-button'
...
```tsx
import { useTableTriggerButton } from '@/registry/tiptap-node/table-node/ui/table-trigger-button'
...
import { ButtonGroup } from '@/registry/tiptap-ui-primitive/button'

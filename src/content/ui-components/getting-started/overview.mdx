    ...
    <CardGrid.Wrapper>
        <CardGrid.Item asChild>
            <Link href="/examples/basics/default-text-editor">
                ...
                <div>
                    <CardGrid.ItemTitle>Integrate a ready-to-go template</CardGrid.ItemTitle>
                    <CardGrid.ItemParagraph>Open source components that correspond to the open source Tiptap extensions.</CardGrid.ItemParagraph>
                </div>
                <CardGrid.ItemFooter>
                </CardGrid.ItemFooter>
            </Link>
        ...
        <CardGrid.Item asChild>
            <Link href="/examples/advanced/collaborative-editing">
                ...
                <div>
                    <CardGrid.ItemTitle>Add individual UI components</CardGrid.ItemTitle>
                    <CardGrid.ItemParagraph>If you’re already using Tiptap, you can pick which UI elements you want to integrate.</CardGrid.ItemParagraph>
                </div>
                <CardGrid.ItemFooter>
                </CardGrid.ItemFooter>
            </Link>
...
In any case, the source code is freely available for inspection and customization:
...
## Primitives
Under the hood, our UI Components are powered by Primitives: a set of basic building blocks (like buttons, dropdown menus, popovers, etc.) that handle accessibility and minimal styling. These primitives make it easy to create or extend any part of the Tiptap UI.

Whether you use our existing components or roll your own, the primitives are there to ensure a consistent, composable foundation.

...
<Callout title="Team plan required" variant="warning">
  The Notion-like template requires at least a **Team plan** subscription to use in production. You can integrate and test it during your trial period. Usage of this template is subject to our [Terms of Service](https://tiptap.dev/pro-license).
</Callout>

...
| `onDestroy`                | When the server will be destroyed         | [Read more](/hocuspocus/server/hooks#ondestroy)                 |
...
The `onDestroy` hooks are called after the server was shut down using the [destroy](/hocuspocus/server/usage#server) method. It should return a Promise.

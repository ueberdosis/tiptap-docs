...
meta:
  title: Hocuspocus Server Examples | Tiptap Collaboration Docs
  description: XXX
  category: Hocuspocus
---
...
Use the [webhook extension](/server/extensions/webhook) to send requests to Laravel when the document is updated, with the document in JSON format (see [here](https://tiptap.dev/hocuspocus/guide/transformations#tiptap>).

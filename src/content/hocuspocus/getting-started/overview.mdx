...
title: Hocuspocus
meta:
  title: Hocuspocus | Tiptap Collaboration Docs
...
- Runs on Node.js, Bun, Deno, and Cloudflare Workers (since v4)
- First-class React bindings via [`@hocuspocus/provider-react`](/hocuspocus/provider/react)

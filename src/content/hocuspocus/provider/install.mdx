---
title: Install Hocuspocus Provider
meta:
  title: Install Hocuspocus Provider | Tiptap Collaboration Docs
  description:
  category: Hocuspocus
---
...
If you're building a React app, take a look at the [React bindings](/hocuspocus/provider/react) — they wrap the provider in components and hooks so you don't have to manage the lifecycle by hand.

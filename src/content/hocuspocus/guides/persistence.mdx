...
title: Persistence
meta:
  title: Persistence | Hocuspocus Docs
  category: Hocuspocus
---
...
Actually, you don't even have to use those 2 hooks! We have already created on top of them a simple abstraction in the form of a [database extension](/hocuspocus/server/extensions/database).

- [Database extension](/hocuspocus/server/extensions/database) - Generic database driver for any database
- [SQLite extension](/hocuspocus/server/extensions/sqlite) - Ready-to-use SQLite persistence
- [S3 extension](/hocuspocus/server/extensions/s3) - Store documents in Amazon S3 or S3-compatible services

...
title: Awareness
meta:
    title: Awareness | Hocuspocus Docs
    category: Hocuspocus
---
...
You can also read more in [our events section of the provider](/hocuspocus/provider/events) about the related events: `awarenessUpdate` and `awarenessChange`.

...
meta:
    title: Custom extensions | Hocuspocus Docs
    category: Hocuspocus
---

## Official extensions

You can see the extensions we have already created [here](/hocuspocus/server/extensions/overview).
...
Notice something? These look like the hooks we introduced in the previous chapters of the guide. And guess what: they work the same way as those hooks. So you should already know what they do and how you can use them. If you're still not sure, check out the [hooks](/hocuspocus/server/hooks) section of this documentation which explains them in more detail.

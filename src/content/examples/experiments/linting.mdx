...
<Callout variant="info" title="Use the AI Suggestion extension">
...
<Callout variant="warning" title="Experiment">
  Experiment, currently not supported or maintained. In production applications, use the [AI
  Suggestion](/content-ai/capabilities/suggestion/overview) extension instead.
</Callout>

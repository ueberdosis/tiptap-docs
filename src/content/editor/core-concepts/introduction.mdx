...
The JSON Schema for valid Tiptap JSON content is available in [`/assets/schemas/tiptap-json-schema.json`](/assets/schemas/tiptap-json-schema.json). You can use it to validate Tiptap JSON before storing or processing it.

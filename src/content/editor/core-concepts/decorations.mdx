...
- Build a term highlighter with the [Vanilla JS tutorial](/guides/decorations-vanilla), [React tutorial](/guides/decorations-react), or [Vue 3 tutorial](/guides/decorations-vue).

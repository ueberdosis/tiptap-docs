...
> **Tip**: For standard patterns like Pandoc blocks or shortcodes, check the [Utility Functions](./utilities) first—they provide ready-made tokenizers.

> **Note**: Unsure what Tokenizers, the Lexer or Tokens are? Check out the [Glossary](./introduction#glossary-of-terms).
...
- Try [Utility Functions](./utilities) for standard patterns before creating custom tokenizers
- Learn how to [integrate markdown support into custom extensions](./extension-integration)
- Check the [API Reference](./api) for complete documentation
- Explore [Examples](./examples) for real-world tokenizer implementations

...
Updating your mark view's attributes is very straight forwward. You can use the `updateAttributes` method provided by the `MarkViewRendererProps` to update the attributes of your mark view.

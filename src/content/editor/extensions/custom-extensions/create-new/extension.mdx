...
Read the [Decorations guide](/editor/core-concepts/decorations) for the three kinds and performance strategies, follow the [React](/guides/decorations-react) or [Vue 3](/guides/decorations-vue) widget tutorial, and use the [Decorations API reference](/editor/api/decorations) for every signature.

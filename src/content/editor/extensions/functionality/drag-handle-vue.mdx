...
```bash
npm install @tiptap/extension-drag-handle-vue-3@beta @tiptap/extension-drag-handle@beta @tiptap/extension-node-range@beta @tiptap/extension-collaboration@beta @tiptap/y-tiptap@beta yjs y-protocols
```

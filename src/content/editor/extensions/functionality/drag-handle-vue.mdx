...
```bash
npm install @tiptap/extension-drag-handle-vue-3@next @tiptap/extension-drag-handle@next @tiptap/extension-node-range@next @tiptap/extension-collaboration@next @tiptap/y-tiptap@next yjs y-protocols
```

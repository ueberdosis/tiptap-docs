...
Appends the menu to a specific container to avoid clipping or z-index issues from parent stacking contexts (e.g. `overflow: hidden`).

Type: `HTMLElement`

Default: `null` (falls back to the editor’s parent element)

...
tags:
  - type: image
    src: https://img.shields.io/npm/v/@tiptap/extension-collaboration/next?label=version
...
```bash
npm install @tiptap/extension-collaboration@beta @tiptap/y-tiptap@beta yjs y-websocket
```

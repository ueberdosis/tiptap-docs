...
Invalid patterns and patterns rejected as unsafe return no results. Regex mode uses RE2-compatible
syntax, so lookarounds and backreferences in the search pattern are not supported.

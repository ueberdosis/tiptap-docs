...
Unmatched groups insert an empty string. A numbered reference that exceeds the pattern's capture
count remains unchanged. An unknown named reference inserts an empty string when the pattern
contains named groups, and remains unchanged when it does not.

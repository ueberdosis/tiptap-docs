...
tags:
  - type: image
    src: https://img.shields.io/npm/v/@tiptap/extension-mention/next?label=version
...
```bash
npm install @tiptap/extension-mention@next
```
...
```bash
npm install @tiptap/suggestion@next
```
...
<CodeDemo path="/Nodes/MultiMention" />

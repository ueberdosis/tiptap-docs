...
Options for resizable images. If defined the node will be wrapped in a [resizable node view](/editor/api/resizable-nodeviews) making it possible to resize the image via resize handles.

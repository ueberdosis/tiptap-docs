...
To add your configuration, pass [an object with settings](/editor/api/editor) to the `Editor` class, like shown here:
...
Most editing features are bundled as [node](/editor/extensions/nodes), [mark](/editor/extensions/marks) or [functionalities](/editor/extensions/functionality). Import what you need and pass them as an array to the editor.
...
The following example will disable the default heading levels 4, 5 and 6 and only allow heading levels 1, 2 and 3:
...
You will probably see something like that in collaborative editing examples. The [`Collaboration`](/editor/extensions/functionality/collaboration) comes with its own history extension. You need to remove or disable the default [`Redo/Undo`](/editor/extensions/functionality/undo-redo) extension to avoid conflicts.

...
<CardGrid.Wrapper className="grid-cols-1 sm:grid-cols-3">
  ...
  <CardGrid.Item asChild>
    <Link href="/editor/getting-started/install/nodejs">
      <CardGrid.ItemImageIcon src={nodejsIcon.src} alt="Node.js logo" />
      <CardGrid.ItemTitle className="text-[1.125rem]">Node.js</CardGrid.ItemTitle>
    </Link>
  </CardGrid.Item>
</CardGrid.Wrapper>

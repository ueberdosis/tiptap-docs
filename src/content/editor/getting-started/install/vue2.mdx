...
This guide details how to integrate Tiptap with your Vue 2 project, including setup and installation. Alternatively you can check out our Vue text editor example [here](/examples/basics/default-text-editor).

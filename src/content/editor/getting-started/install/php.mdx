...
We provide [an official PHP package to work with Tiptap content](/editor/api/utilities/tiptap-for-php). You can transform Tiptap-compatible JSON to HTML, and the other way around, sanitize your content, or just modify it.

...
Use the `compareDocuments` utility to compare two documents. It takes two Tiptap JSON documents and returns a list of `Change` objects that you can display.

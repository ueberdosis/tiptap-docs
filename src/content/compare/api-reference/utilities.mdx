...
Returns a changeset containing both documents and their changes. See [Changeset](/compare/api-reference/types#changeset).
...
Returns a changeset containing both fragments and their changes. See [Changeset](/compare/api-reference/types#changeset).
...
Returns a changeset containing both versions and their changes. Changes include metadata from the change history, such as a `userId` when available. See [Changeset](/compare/api-reference/types#changeset).
...
Returns a changeset containing the initial and final documents and their changes. Changes include metadata associated with the steps that produced them. See [Changeset](/compare/api-reference/types#changeset).

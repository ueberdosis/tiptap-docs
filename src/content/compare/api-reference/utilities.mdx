...
- `docA` (`JSONContent`): The original fragment as a Tiptap JSON document.
- `docB` (`JSONContent`): The modified fragment as a Tiptap JSON document.
...
Returns the diff suggestions that are currently shown on the editor.

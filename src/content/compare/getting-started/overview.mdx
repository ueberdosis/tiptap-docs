---
title: Compare documents with Tiptap
tags:
  - type: beta
  - type: restricted
meta:
  title: Compare documents with Tiptap | Tiptap Compare Docs
...
Tiptap Compare is headless: you have full control over how changes are displayed and styled. The comparison itself runs without an editor instance, so you can deploy it client-side or server-side.

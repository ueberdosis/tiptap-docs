...
Types exported by `@tiptap-pro/extension-content-protection`. See also [policy types](/content-protection/api-reference/policy) and [redaction types](/content-protection/api-reference/rendering).
...
Output from [`getReadableContent`](/content-protection/api-reference/utilities#getreadablecontent).

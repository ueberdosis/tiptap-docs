...
- Access-request controls belong to the application. Change access with [`setContentProtectionPolicy`](/content-protection/api-reference/commands#setcontentprotectionpolicy).
...
- [`getReadableContent`](/content-protection/api-reference/utilities#getreadablecontent) returns a presentation tree and text. It does not call `renderRedaction`; pass custom `redactionText` explicitly.

...
4. **Check the configuration.** As soon as you save the environment, your document server boots up. Visit the [configuration page](https://cloud.tiptap.dev/v2/configuration/document-server) to copy your document server ID, API keys, and other connection details.

...
<Callout title="Set up access to Tiptap’s private repository" variant="info">
  To use this pro extension, you need access to Tiptap's private repository. Sign up for a free
  [Tiptap account](https://cloud.tiptap.dev/register) and follow our [access

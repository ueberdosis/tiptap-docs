...
<Callout title="Not yet available for on-premises deployments" variant="warning" size="md">
  ...
  you run Collaboration on-premises, use [Legacy authentication](/authentication/legacy) instead.
  We're shipping the new authentication for on-premises deployments in September 2026.
</Callout>

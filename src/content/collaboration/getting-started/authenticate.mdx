...
<Callout title="Integrate roles into your setup" variant="hint">
  Implementing Role-based access control requires you to set up and manage role assignments within
  your own system. The provided code snippet simply demonstrates how to align these roles with

...
```bash
npm install @tiptap/extension-document@next @tiptap/extension-paragraph@next @tiptap/extension-text@next @tiptap/react@next
```
...
```bash
npm install @tiptap/extension-collaboration@next @tiptap/y-tiptap@next yjs y-protocols
```

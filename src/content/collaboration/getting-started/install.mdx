...
This guide will get you started with collaborative editing in the Tiptap Editor. If you're already using Tiptap Editor, feel free to skip ahead to the "Add Collaboration" section.
...
## Start your Collaboration app
1. **Activate your Tiptap account trial or subscription.** If you have not enabled the free trial yet, [turn it on first](https://cloud.tiptap.dev/v2/billing) (no credit card needed).
2. **Add an environment.** On your [Dashboard](https://cloud.tiptap.dev/), click the »Add environment« button and enter a name, pick the region that is closest to your users and choose the environment type (development or production).
...
### Connect to your Collaboration app

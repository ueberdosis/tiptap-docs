...
Collaboration adds real-time collaborative editing to your editor. Presence indicators show who’s active, awareness highlights each user’s cursor and selection, and built-in [version history](/collaboration/documents/snapshot) and [Comments](/comments/getting-started/overview) track every change.
...
- [Version history](/collaboration/documents/snapshot) – install the Collaboration Snapshot extension and let users restore any previous state.

...
export const MobileNavigationDropdown = () => {
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className="flex flex-col gap-6 z-50 py-6 px-2 lg:py-3 text-popover-foreground bg-popover border rounded-lg border-border w-[14rem] lg:w-[10.43rem]">
          {options.map((group, i) => (
            <div key={`group__${i}`}>

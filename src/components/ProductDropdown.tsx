...
export const ProductDropdown = () => {
  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className="flex flex-col gap-6 z-50 py-6 px-2 lg:py-3 text-black dark:text-white bg-white dark:bg-gray-900 border rounded-lg shadow-md border-grayAlpha-100 dark:border-gray-800 w-[14rem] lg:w-[10.43rem]">
          <div>
            <div className="uppercase font-bold leading-[120%] text-xs mb-3 px-2 block lg:hidden dark:text-gray-400">
              Documentations
            </div>
            {options.map((option) => (
          ...
          <div className="block lg:hidden">
            <div className="uppercase font-bold leading-[120%] text-xs px-2 mb-3 block lg:hidden dark:text-gray-400">
              Others
            </div>

...
const VARIANT_CONFIG: Record<
  ...
  { title: string; description: string; showWaitlist: boolean; contactUrl?: string, buttonText?: string }
> = {
  migration: {
  ...
  'tracked-changes': {
    ...
    description:
      'Add Tracked Changes to any Tiptap subscription. No silent overwrites: ensure every edit is accepted or rejected by a human—even those generated by AI.',
    showWaitlist: false,
...
export const EnterpriseCallout = forwardRef<HTMLDivElement, EnterpriseCalloutProps>(
  (
    ...
    const { title, description, showWaitlist, contactUrl, buttonText } = VARIANT_CONFIG[variant]
    ...
    const BUTTON_TEXT = buttonText ?? 'Talk to an engineer'
